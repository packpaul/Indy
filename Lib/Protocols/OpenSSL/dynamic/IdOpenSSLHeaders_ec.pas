...
begin
  ...
  try
    EC_GFp_simple_method := LoadFunction('EC_GFp_simple_method', LFailed);
    EC_GFp_mont_method := LoadFunction('EC_GFp_mont_method', LFailed);
    EC_GFp_nist_method := LoadFunction('EC_GFp_nist_method', LFailed);
    EC_GFp_nistp224_method := LoadFunction('EC_GFp_nistp224_method', LFailed);
    EC_GFp_nistp256_method := LoadFunction('EC_GFp_nistp256_method', LFailed);
    EC_GFp_nistp521_method := LoadFunction('EC_GFp_nistp521_method', LFailed);
    EC_GF2m_simple_method := LoadFunction('EC_GF2m_simple_method', LFailed);
    EC_GROUP_new := LoadFunction('EC_GROUP_new', LFailed);
    EC_GROUP_free := LoadFunction('EC_GROUP_free', LFailed);
    EC_GROUP_clear_free := LoadFunction('EC_GROUP_clear_free', LFailed);
    EC_GROUP_copy := LoadFunction('EC_GROUP_copy', LFailed);
    EC_GROUP_dup := LoadFunction('EC_GROUP_dup', LFailed);
    EC_GROUP_method_of := LoadFunction('EC_GROUP_method_of', LFailed);
    EC_METHOD_get_field_type := LoadFunction('EC_METHOD_get_field_type', LFailed);
    EC_GROUP_set_generator := LoadFunction('EC_GROUP_set_generator', LFailed);
    EC_GROUP_get0_generator := LoadFunction('EC_GROUP_get0_generator', LFailed);
    EC_GROUP_get_mont_data := LoadFunction('EC_GROUP_get_mont_data', LFailed);
    EC_GROUP_get_order := LoadFunction('EC_GROUP_get_order', LFailed);
    EC_GROUP_get0_order := LoadFunction('EC_GROUP_get0_order', LFailed);
    EC_GROUP_order_bits := LoadFunction('EC_GROUP_order_bits', LFailed);
    EC_GROUP_get_cofactor := LoadFunction('EC_GROUP_get_cofactor', LFailed);
    EC_GROUP_get0_cofactor := LoadFunction('EC_GROUP_get0_cofactor', LFailed);
    EC_GROUP_set_curve_name := LoadFunction('EC_GROUP_set_curve_name', LFailed);
    EC_GROUP_get_curve_name := LoadFunction('EC_GROUP_get_curve_name', LFailed);
    EC_GROUP_set_asn1_flag := LoadFunction('EC_GROUP_set_asn1_flag', LFailed);
    EC_GROUP_get_asn1_flag := LoadFunction('EC_GROUP_get_asn1_flag', LFailed);
    EC_GROUP_set_point_conversion_form := LoadFunction('EC_GROUP_set_point_conversion_form', LFailed);
    EC_GROUP_get_point_conversion_form := LoadFunction('EC_GROUP_get_point_conversion_form', LFailed);
    EC_GROUP_get0_seed := LoadFunction('EC_GROUP_get0_seed', LFailed);
    EC_GROUP_get_seed_len := LoadFunction('EC_GROUP_get_seed_len', LFailed);
    EC_GROUP_set_seed := LoadFunction('EC_GROUP_set_seed', LFailed);
    EC_GROUP_set_curve := LoadFunction('EC_GROUP_set_curve', LFailed);
    EC_GROUP_get_curve := LoadFunction('EC_GROUP_get_curve', LFailed);
    EC_GROUP_set_curve_GFp := LoadFunction('EC_GROUP_set_curve_GFp', LFailed);
    EC_GROUP_get_curve_GFp := LoadFunction('EC_GROUP_get_curve_GFp', LFailed);
    EC_GROUP_set_curve_GF2m := LoadFunction('EC_GROUP_set_curve_GF2m', LFailed);
    EC_GROUP_get_curve_GF2m := LoadFunction('EC_GROUP_get_curve_GF2m', LFailed);
    EC_GROUP_get_degree := LoadFunction('EC_GROUP_get_degree', LFailed);
    EC_GROUP_check := LoadFunction('EC_GROUP_check', LFailed);
    EC_GROUP_check_discriminant := LoadFunction('EC_GROUP_check_discriminant', LFailed);
    EC_GROUP_cmp := LoadFunction('EC_GROUP_cmp', LFailed);
    EC_GROUP_new_curve_GFp := LoadFunction('EC_GROUP_new_curve_GFp', LFailed);
    EC_GROUP_new_curve_GF2m := LoadFunction('EC_GROUP_new_curve_GF2m', LFailed);
    EC_GROUP_new_by_curve_name := LoadFunction('EC_GROUP_new_by_curve_name', LFailed);
    EC_GROUP_new_from_ecparameters := LoadFunction('EC_GROUP_new_from_ecparameters', LFailed);
    EC_GROUP_get_ecparameters := LoadFunction('EC_GROUP_get_ecparameters', LFailed);
    EC_GROUP_new_from_ecpkparameters := LoadFunction('EC_GROUP_new_from_ecpkparameters', LFailed);
    EC_GROUP_get_ecpkparameters := LoadFunction('EC_GROUP_get_ecpkparameters', LFailed);
    EC_get_builtin_curves := LoadFunction('EC_get_builtin_curves', LFailed);
    EC_curve_nid2nist := LoadFunction('EC_curve_nid2nist', LFailed);
    EC_curve_nist2nid := LoadFunction('EC_curve_nist2nid', LFailed);
    EC_POINT_new := LoadFunction('EC_POINT_new', LFailed);
    EC_POINT_free := LoadFunction('EC_POINT_free', LFailed);
    EC_POINT_clear_free := LoadFunction('EC_POINT_clear_free', LFailed);
    EC_POINT_copy := LoadFunction('EC_POINT_copy', LFailed);
    EC_POINT_dup := LoadFunction('EC_POINT_dup', LFailed);
    EC_POINT_method_of := LoadFunction('EC_POINT_method_of', LFailed);
    EC_POINT_set_to_infinity := LoadFunction('EC_POINT_set_to_infinity', LFailed);
    EC_POINT_set_Jprojective_coordinates_GFp := LoadFunction('EC_POINT_set_Jprojective_coordinates_GFp', LFailed);
    EC_POINT_get_Jprojective_coordinates_GFp := LoadFunction('EC_POINT_get_Jprojective_coordinates_GFp', LFailed);
    EC_POINT_set_affine_coordinates := LoadFunction('EC_POINT_set_affine_coordinates', LFailed);
    EC_POINT_get_affine_coordinates := LoadFunction('EC_POINT_get_affine_coordinates', LFailed);
    EC_POINT_set_affine_coordinates_GFp := LoadFunction('EC_POINT_set_affine_coordinates_GFp', LFailed);
    EC_POINT_get_affine_coordinates_GFp := LoadFunction('EC_POINT_get_affine_coordinates_GFp', LFailed);
    EC_POINT_set_compressed_coordinates := LoadFunction('EC_POINT_set_compressed_coordinates', LFailed);
    EC_POINT_set_compressed_coordinates_GFp := LoadFunction('EC_POINT_set_compressed_coordinates_GFp', LFailed);
    EC_POINT_set_affine_coordinates_GF2m := LoadFunction('EC_POINT_set_affine_coordinates_GF2m', LFailed);
    EC_POINT_get_affine_coordinates_GF2m := LoadFunction('EC_POINT_get_affine_coordinates_GF2m', LFailed);
    EC_POINT_set_compressed_coordinates_GF2m := LoadFunction('EC_POINT_set_compressed_coordinates_GF2m', LFailed);
    EC_POINT_point2oct := LoadFunction('EC_POINT_point2oct', LFailed);
    EC_POINT_oct2point := LoadFunction('EC_POINT_oct2point', LFailed);
    EC_POINT_point2buf := LoadFunction('EC_POINT_point2buf', LFailed);
    EC_POINT_point2bn := LoadFunction('EC_POINT_point2bn', LFailed);
    EC_POINT_bn2point := LoadFunction('EC_POINT_bn2point', LFailed);
    EC_POINT_point2hex := LoadFunction('EC_POINT_point2hex', LFailed);
    EC_POINT_hex2point := LoadFunction('EC_POINT_hex2point', LFailed);
    EC_POINT_add := LoadFunction('EC_POINT_add', LFailed);
    EC_POINT_dbl := LoadFunction('EC_POINT_dbl', LFailed);
    EC_POINT_invert := LoadFunction('EC_POINT_invert', LFailed);
    EC_POINT_is_at_infinity := LoadFunction('EC_POINT_is_at_infinity', LFailed);
    EC_POINT_is_on_curve := LoadFunction('EC_POINT_is_on_curve', LFailed);
    EC_POINT_cmp := LoadFunction('EC_POINT_cmp', LFailed);
    EC_POINT_make_affine := LoadFunction('EC_POINT_make_affine', LFailed);
    EC_POINTs_make_affine := LoadFunction('EC_POINTs_make_affine', LFailed);
    EC_POINTs_mul := LoadFunction('EC_POINTs_mul', LFailed);
    EC_POINT_mul := LoadFunction('EC_POINT_mul', LFailed);
    EC_GROUP_precompute_mult := LoadFunction('EC_GROUP_precompute_mult', LFailed);
    EC_GROUP_have_precompute_mult := LoadFunction('EC_GROUP_have_precompute_mult', LFailed);
    ECPKPARAMETERS_it := LoadFunction('ECPKPARAMETERS_it', LFailed);
    ECPKPARAMETERS_new := LoadFunction('ECPKPARAMETERS_new', LFailed);
    ECPKPARAMETERS_free := LoadFunction('ECPKPARAMETERS_free', LFailed);
    ECPARAMETERS_it := LoadFunction('ECPARAMETERS_it', LFailed);
    ECPARAMETERS_new := LoadFunction('ECPARAMETERS_new', LFailed);
    ECPARAMETERS_free := LoadFunction('ECPARAMETERS_free', LFailed);
    EC_GROUP_get_basis_type := LoadFunction('EC_GROUP_get_basis_type', LFailed);
    EC_GROUP_get_trinomial_basis := LoadFunction('EC_GROUP_get_trinomial_basis', LFailed);
    EC_GROUP_get_pentanomial_basis := LoadFunction('EC_GROUP_get_pentanomial_basis', LFailed);
    d2i_ECPKParameters := LoadFunction('d2i_ECPKParameters', LFailed);
    i2d_ECPKParameters := LoadFunction('i2d_ECPKParameters', LFailed);
    ECPKParameters_print := LoadFunction('ECPKParameters_print', LFailed);
    EC_KEY_new := LoadFunction('EC_KEY_new', LFailed);
    EC_KEY_get_flags := LoadFunction('EC_KEY_get_flags', LFailed);
    EC_KEY_set_flags := LoadFunction('EC_KEY_set_flags', LFailed);
    EC_KEY_clear_flags := LoadFunction('EC_KEY_clear_flags', LFailed);
    EC_KEY_new_by_curve_name := LoadFunction('EC_KEY_new_by_curve_name', LFailed);
    EC_KEY_free := LoadFunction('EC_KEY_free', LFailed);
    EC_KEY_copy := LoadFunction('EC_KEY_copy', LFailed);
    EC_KEY_dup := LoadFunction('EC_KEY_dup', LFailed);
    EC_KEY_up_ref := LoadFunction('EC_KEY_up_ref', LFailed);
    EC_KEY_get0_engine := LoadFunction('EC_KEY_get0_engine', LFailed);
    EC_KEY_get0_group := LoadFunction('EC_KEY_get0_group', LFailed);
    EC_KEY_set_group := LoadFunction('EC_KEY_set_group', LFailed);
    EC_KEY_get0_private_key := LoadFunction('EC_KEY_get0_private_key', LFailed);
    EC_KEY_set_private_key := LoadFunction('EC_KEY_set_private_key', LFailed);
    EC_KEY_get0_public_key := LoadFunction('EC_KEY_get0_public_key', LFailed);
    EC_KEY_set_public_key := LoadFunction('EC_KEY_set_public_key', LFailed);
    EC_KEY_get_enc_flags := LoadFunction('EC_KEY_get_enc_flags', LFailed);
    EC_KEY_set_enc_flags := LoadFunction('EC_KEY_set_enc_flags', LFailed);
    EC_KEY_get_conv_form := LoadFunction('EC_KEY_get_conv_form', LFailed);
    EC_KEY_set_conv_form := LoadFunction('EC_KEY_set_conv_form', LFailed);
    EC_KEY_set_ex_data := LoadFunction('EC_KEY_set_ex_data', LFailed);
    EC_KEY_get_ex_data := LoadFunction('EC_KEY_get_ex_data', LFailed);
    EC_KEY_set_asn1_flag := LoadFunction('EC_KEY_set_asn1_flag', LFailed);
    EC_KEY_precompute_mult := LoadFunction('EC_KEY_precompute_mult', LFailed);
    EC_KEY_generate_key := LoadFunction('EC_KEY_generate_key', LFailed);
    EC_KEY_check_key := LoadFunction('EC_KEY_check_key', LFailed);
    EC_KEY_can_sign := LoadFunction('EC_KEY_can_sign', LFailed);
    EC_KEY_set_public_key_affine_coordinates := LoadFunction('EC_KEY_set_public_key_affine_coordinates', LFailed);
    EC_KEY_key2buf := LoadFunction('EC_KEY_key2buf', LFailed);
    EC_KEY_oct2key := LoadFunction('EC_KEY_oct2key', LFailed);
    EC_KEY_oct2priv := LoadFunction('EC_KEY_oct2priv', LFailed);
    EC_KEY_priv2oct := LoadFunction('EC_KEY_priv2oct', LFailed);
    EC_KEY_priv2buf := LoadFunction('EC_KEY_priv2buf', LFailed);
    d2i_ECPrivateKey := LoadFunction('d2i_ECPrivateKey', LFailed);
    i2d_ECPrivateKey := LoadFunction('i2d_ECPrivateKey', LFailed);
    o2i_ECPublicKey := LoadFunction('o2i_ECPublicKey', LFailed);
    i2o_ECPublicKey := LoadFunction('i2o_ECPublicKey', LFailed);
    ECParameters_print := LoadFunction('ECParameters_print', LFailed);
    EC_KEY_print := LoadFunction('EC_KEY_print', LFailed);
    EC_KEY_OpenSSL := LoadFunction('EC_KEY_OpenSSL', LFailed);
    EC_KEY_get_default_method := LoadFunction('EC_KEY_get_default_method', LFailed);
    EC_KEY_set_default_method := LoadFunction('EC_KEY_set_default_method', LFailed);
    EC_KEY_get_method := LoadFunction('EC_KEY_get_method', LFailed);
    EC_KEY_set_method := LoadFunction('EC_KEY_set_method', LFailed);
    EC_KEY_new_method := LoadFunction('EC_KEY_new_method', LFailed);
    ECDH_KDF_X9_62 := LoadFunction('ECDH_KDF_X9_62', LFailed);
    ECDH_compute_key := LoadFunction('ECDH_compute_key', LFailed);
    ECDSA_SIG_new := LoadFunction('ECDSA_SIG_new', LFailed);
    ECDSA_SIG_free := LoadFunction('ECDSA_SIG_free', LFailed);
    i2d_ECDSA_SIG := LoadFunction('i2d_ECDSA_SIG', LFailed);
    d2i_ECDSA_SIG := LoadFunction('d2i_ECDSA_SIG', LFailed);
    ECDSA_SIG_get0 := LoadFunction('ECDSA_SIG_get0', LFailed);
    ECDSA_SIG_get0_r := LoadFunction('ECDSA_SIG_get0_r', LFailed);
    ECDSA_SIG_get0_s := LoadFunction('ECDSA_SIG_get0_s', LFailed);
    ECDSA_SIG_set0 := LoadFunction('ECDSA_SIG_set0', LFailed);
    ECDSA_do_sign := LoadFunction('ECDSA_do_sign', LFailed);
    ECDSA_do_sign_ex := LoadFunction('ECDSA_do_sign_ex', LFailed);
    ECDSA_do_verify := LoadFunction('ECDSA_do_verify', LFailed);
    ECDSA_sign_setup := LoadFunction('ECDSA_sign_setup', LFailed);
    ECDSA_sign := LoadFunction('ECDSA_sign', LFailed);
    ECDSA_sign_ex := LoadFunction('ECDSA_sign_ex', LFailed);
    ECDSA_verify := LoadFunction('ECDSA_verify', LFailed);
    ECDSA_size := LoadFunction('ECDSA_size', LFailed);
    EC_KEY_METHOD_new := LoadFunction('EC_KEY_METHOD_new', LFailed);
    EC_KEY_METHOD_free := LoadFunction('EC_KEY_METHOD_free', LFailed);
    EC_KEY_METHOD_set_init := LoadFunction('EC_KEY_METHOD_set_init', LFailed);
    EC_KEY_METHOD_set_keygen := LoadFunction('EC_KEY_METHOD_set_keygen', LFailed);
    EC_KEY_METHOD_set_compute_key := LoadFunction('EC_KEY_METHOD_set_compute_key', LFailed);
    EC_KEY_METHOD_set_sign := LoadFunction('EC_KEY_METHOD_set_sign', LFailed);
    EC_KEY_METHOD_set_verify := LoadFunction('EC_KEY_METHOD_set_verify', LFailed);
    EC_KEY_METHOD_get_init := LoadFunction('EC_KEY_METHOD_get_init', LFailed);
    EC_KEY_METHOD_get_keygen := LoadFunction('EC_KEY_METHOD_get_keygen', LFailed);
    EC_KEY_METHOD_get_compute_key := LoadFunction('EC_KEY_METHOD_get_compute_key', LFailed);
    EC_KEY_METHOD_get_sign := LoadFunction('EC_KEY_METHOD_get_sign', LFailed);
    EC_KEY_METHOD_get_verify := LoadFunction('EC_KEY_METHOD_get_verify', LFailed);

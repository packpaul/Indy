...
begin
  ...
  try
    TS_REQ_new := LoadFunction('TS_REQ_new', LFailed);
    TS_REQ_free := LoadFunction('TS_REQ_free', LFailed);
    i2d_TS_REQ := LoadFunction('i2d_TS_REQ', LFailed);
    d2i_TS_REQ := LoadFunction('d2i_TS_REQ', LFailed);
    TS_REQ_dup := LoadFunction('TS_REQ_dup', LFailed);
    d2i_TS_REQ_bio := LoadFunction('d2i_TS_REQ_bio', LFailed);
    i2d_TS_REQ_bio := LoadFunction('i2d_TS_REQ_bio', LFailed);
    TS_MSG_IMPRINT_new := LoadFunction('TS_MSG_IMPRINT_new', LFailed);
    TS_MSG_IMPRINT_free := LoadFunction('TS_MSG_IMPRINT_free', LFailed);
    i2d_TS_MSG_IMPRINT := LoadFunction('i2d_TS_MSG_IMPRINT', LFailed);
    d2i_TS_MSG_IMPRINT := LoadFunction('d2i_TS_MSG_IMPRINT', LFailed);
    TS_MSG_IMPRINT_dup := LoadFunction('TS_MSG_IMPRINT_dup', LFailed);
    d2i_TS_MSG_IMPRINT_bio := LoadFunction('d2i_TS_MSG_IMPRINT_bio', LFailed);
    i2d_TS_MSG_IMPRINT_bio := LoadFunction('i2d_TS_MSG_IMPRINT_bio', LFailed);
    TS_RESP_new := LoadFunction('TS_RESP_new', LFailed);
    TS_RESP_free := LoadFunction('TS_RESP_free', LFailed);
    i2d_TS_RESP := LoadFunction('i2d_TS_RESP', LFailed);
    d2i_TS_RESP := LoadFunction('d2i_TS_RESP', LFailed);
    PKCS7_to_TS_TST_INFO := LoadFunction('PKCS7_to_TS_TST_INFO', LFailed);
    TS_RESP_dup := LoadFunction('TS_RESP_dup', LFailed);
    d2i_TS_RESP_bio := LoadFunction('d2i_TS_RESP_bio', LFailed);
    i2d_TS_RESP_bio := LoadFunction('i2d_TS_RESP_bio', LFailed);
    TS_STATUS_INFO_new := LoadFunction('TS_STATUS_INFO_new', LFailed);
    TS_STATUS_INFO_free := LoadFunction('TS_STATUS_INFO_free', LFailed);
    i2d_TS_STATUS_INFO := LoadFunction('i2d_TS_STATUS_INFO', LFailed);
    d2i_TS_STATUS_INFO := LoadFunction('d2i_TS_STATUS_INFO', LFailed);
    TS_STATUS_INFO_dup := LoadFunction('TS_STATUS_INFO_dup', LFailed);
    TS_TST_INFO_new := LoadFunction('TS_TST_INFO_new', LFailed);
    TS_TST_INFO_free := LoadFunction('TS_TST_INFO_free', LFailed);
    i2d_TS_TST_INFO := LoadFunction('i2d_TS_TST_INFO', LFailed);
    d2i_TS_TST_INFO := LoadFunction('d2i_TS_TST_INFO', LFailed);
    TS_TST_INFO_dup := LoadFunction('TS_TST_INFO_dup', LFailed);
    d2i_TS_TST_INFO_bio := LoadFunction('d2i_TS_TST_INFO_bio', LFailed);
    i2d_TS_TST_INFO_bio := LoadFunction('i2d_TS_TST_INFO_bio', LFailed);
    TS_ACCURACY_new := LoadFunction('TS_ACCURACY_new', LFailed);
    TS_ACCURACY_free := LoadFunction('TS_ACCURACY_free', LFailed);
    i2d_TS_ACCURACY := LoadFunction('i2d_TS_ACCURACY', LFailed);
    d2i_TS_ACCURACY := LoadFunction('d2i_TS_ACCURACY', LFailed);
    TS_ACCURACY_dup := LoadFunction('TS_ACCURACY_dup', LFailed);
    ESS_ISSUER_SERIAL_new := LoadFunction('ESS_ISSUER_SERIAL_new', LFailed);
    ESS_ISSUER_SERIAL_free := LoadFunction('ESS_ISSUER_SERIAL_free', LFailed);
    i2d_ESS_ISSUER_SERIAL := LoadFunction('i2d_ESS_ISSUER_SERIAL', LFailed);
    d2i_ESS_ISSUER_SERIAL := LoadFunction('d2i_ESS_ISSUER_SERIAL', LFailed);
    ESS_ISSUER_SERIAL_dup := LoadFunction('ESS_ISSUER_SERIAL_dup', LFailed);
    ESS_CERT_ID_new := LoadFunction('ESS_CERT_ID_new', LFailed);
    ESS_CERT_ID_free := LoadFunction('ESS_CERT_ID_free', LFailed);
    i2d_ESS_CERT_ID := LoadFunction('i2d_ESS_CERT_ID', LFailed);
    d2i_ESS_CERT_ID := LoadFunction('d2i_ESS_CERT_ID', LFailed);
    ESS_CERT_ID_dup := LoadFunction('ESS_CERT_ID_dup', LFailed);
    ESS_SIGNING_CERT_new := LoadFunction('ESS_SIGNING_CERT_new', LFailed);
    ESS_SIGNING_CERT_free := LoadFunction('ESS_SIGNING_CERT_free', LFailed);
    i2d_ESS_SIGNING_CERT := LoadFunction('i2d_ESS_SIGNING_CERT', LFailed);
    d2i_ESS_SIGNING_CERT := LoadFunction('d2i_ESS_SIGNING_CERT', LFailed);
    ESS_SIGNING_CERT_dup := LoadFunction('ESS_SIGNING_CERT_dup', LFailed);
    ESS_CERT_ID_V2_new := LoadFunction('ESS_CERT_ID_V2_new', LFailed);
    ESS_CERT_ID_V2_free := LoadFunction('ESS_CERT_ID_V2_free', LFailed);
    i2d_ESS_CERT_ID_V2 := LoadFunction('i2d_ESS_CERT_ID_V2', LFailed);
    d2i_ESS_CERT_ID_V2 := LoadFunction('d2i_ESS_CERT_ID_V2', LFailed);
    ESS_CERT_ID_V2_dup := LoadFunction('ESS_CERT_ID_V2_dup', LFailed);
    ESS_SIGNING_CERT_V2_new := LoadFunction('ESS_SIGNING_CERT_V2_new', LFailed);
    ESS_SIGNING_CERT_V2_free := LoadFunction('ESS_SIGNING_CERT_V2_free', LFailed);
    i2d_ESS_SIGNING_CERT_V2 := LoadFunction('i2d_ESS_SIGNING_CERT_V2', LFailed);
    d2i_ESS_SIGNING_CERT_V2 := LoadFunction('d2i_ESS_SIGNING_CERT_V2', LFailed);
    ESS_SIGNING_CERT_V2_dup := LoadFunction('ESS_SIGNING_CERT_V2_dup', LFailed);
    TS_REQ_set_version := LoadFunction('TS_REQ_set_version', LFailed);
    TS_REQ_get_version := LoadFunction('TS_REQ_get_version', LFailed);
    TS_STATUS_INFO_set_status := LoadFunction('TS_STATUS_INFO_set_status', LFailed);
    TS_STATUS_INFO_get0_status := LoadFunction('TS_STATUS_INFO_get0_status', LFailed);
    TS_REQ_set_msg_imprint := LoadFunction('TS_REQ_set_msg_imprint', LFailed);
    TS_REQ_get_msg_imprint := LoadFunction('TS_REQ_get_msg_imprint', LFailed);
    TS_MSG_IMPRINT_set_algo := LoadFunction('TS_MSG_IMPRINT_set_algo', LFailed);
    TS_MSG_IMPRINT_get_algo := LoadFunction('TS_MSG_IMPRINT_get_algo', LFailed);
    TS_MSG_IMPRINT_set_msg := LoadFunction('TS_MSG_IMPRINT_set_msg', LFailed);
    TS_MSG_IMPRINT_get_msg := LoadFunction('TS_MSG_IMPRINT_get_msg', LFailed);
    TS_REQ_set_policy_id := LoadFunction('TS_REQ_set_policy_id', LFailed);
    TS_REQ_get_policy_id := LoadFunction('TS_REQ_get_policy_id', LFailed);
    TS_REQ_set_nonce := LoadFunction('TS_REQ_set_nonce', LFailed);
    TS_REQ_get_nonce := LoadFunction('TS_REQ_get_nonce', LFailed);
    TS_REQ_set_cert_req := LoadFunction('TS_REQ_set_cert_req', LFailed);
    TS_REQ_get_cert_req := LoadFunction('TS_REQ_get_cert_req', LFailed);
    TS_REQ_ext_free := LoadFunction('TS_REQ_ext_free', LFailed);
    TS_REQ_get_ext_count := LoadFunction('TS_REQ_get_ext_count', LFailed);
    TS_REQ_get_ext_by_NID := LoadFunction('TS_REQ_get_ext_by_NID', LFailed);
    TS_REQ_get_ext_by_OBJ := LoadFunction('TS_REQ_get_ext_by_OBJ', LFailed);
    TS_REQ_get_ext_by_critical := LoadFunction('TS_REQ_get_ext_by_critical', LFailed);
    TS_REQ_get_ext := LoadFunction('TS_REQ_get_ext', LFailed);
    TS_REQ_delete_ext := LoadFunction('TS_REQ_delete_ext', LFailed);
    TS_REQ_add_ext := LoadFunction('TS_REQ_add_ext', LFailed);
    TS_REQ_get_ext_d2i := LoadFunction('TS_REQ_get_ext_d2i', LFailed);
    TS_REQ_print_bio := LoadFunction('TS_REQ_print_bio', LFailed);
    TS_RESP_set_status_info := LoadFunction('TS_RESP_set_status_info', LFailed);
    TS_RESP_get_status_info := LoadFunction('TS_RESP_get_status_info', LFailed);
    TS_RESP_set_tst_info := LoadFunction('TS_RESP_set_tst_info', LFailed);
    TS_RESP_get_token := LoadFunction('TS_RESP_get_token', LFailed);
    TS_RESP_get_tst_info := LoadFunction('TS_RESP_get_tst_info', LFailed);
    TS_TST_INFO_set_version := LoadFunction('TS_TST_INFO_set_version', LFailed);
    TS_TST_INFO_get_version := LoadFunction('TS_TST_INFO_get_version', LFailed);
    TS_TST_INFO_set_policy_id := LoadFunction('TS_TST_INFO_set_policy_id', LFailed);
    TS_TST_INFO_get_policy_id := LoadFunction('TS_TST_INFO_get_policy_id', LFailed);
    TS_TST_INFO_set_msg_imprint := LoadFunction('TS_TST_INFO_set_msg_imprint', LFailed);
    TS_TST_INFO_get_msg_imprint := LoadFunction('TS_TST_INFO_get_msg_imprint', LFailed);
    TS_TST_INFO_set_serial := LoadFunction('TS_TST_INFO_set_serial', LFailed);
    TS_TST_INFO_get_serial := LoadFunction('TS_TST_INFO_get_serial', LFailed);
    TS_TST_INFO_set_time := LoadFunction('TS_TST_INFO_set_time', LFailed);
    TS_TST_INFO_get_time := LoadFunction('TS_TST_INFO_get_time', LFailed);
    TS_TST_INFO_set_accuracy := LoadFunction('TS_TST_INFO_set_accuracy', LFailed);
    TS_TST_INFO_get_accuracy := LoadFunction('TS_TST_INFO_get_accuracy', LFailed);
    TS_ACCURACY_set_seconds := LoadFunction('TS_ACCURACY_set_seconds', LFailed);
    TS_ACCURACY_get_seconds := LoadFunction('TS_ACCURACY_get_seconds', LFailed);
    TS_ACCURACY_set_millis := LoadFunction('TS_ACCURACY_set_millis', LFailed);
    TS_ACCURACY_get_millis := LoadFunction('TS_ACCURACY_get_millis', LFailed);
    TS_ACCURACY_set_micros := LoadFunction('TS_ACCURACY_set_micros', LFailed);
    TS_ACCURACY_get_micros := LoadFunction('TS_ACCURACY_get_micros', LFailed);
    TS_TST_INFO_set_ordering := LoadFunction('TS_TST_INFO_set_ordering', LFailed);
    TS_TST_INFO_get_ordering := LoadFunction('TS_TST_INFO_get_ordering', LFailed);
    TS_TST_INFO_set_nonce := LoadFunction('TS_TST_INFO_set_nonce', LFailed);
    TS_TST_INFO_get_nonce := LoadFunction('TS_TST_INFO_get_nonce', LFailed);
    TS_TST_INFO_set_tsa := LoadFunction('TS_TST_INFO_set_tsa', LFailed);
    TS_TST_INFO_get_tsa := LoadFunction('TS_TST_INFO_get_tsa', LFailed);
    TS_TST_INFO_ext_free := LoadFunction('TS_TST_INFO_ext_free', LFailed);
    TS_TST_INFO_get_ext_count := LoadFunction('TS_TST_INFO_get_ext_count', LFailed);
    TS_TST_INFO_get_ext_by_NID := LoadFunction('TS_TST_INFO_get_ext_by_NID', LFailed);
    TS_TST_INFO_get_ext_by_OBJ := LoadFunction('TS_TST_INFO_get_ext_by_OBJ', LFailed);
    TS_TST_INFO_get_ext_by_critical := LoadFunction('TS_TST_INFO_get_ext_by_critical', LFailed);
    TS_TST_INFO_get_ext := LoadFunction('TS_TST_INFO_get_ext', LFailed);
    TS_TST_INFO_delete_ext := LoadFunction('TS_TST_INFO_delete_ext', LFailed);
    TS_TST_INFO_add_ext := LoadFunction('TS_TST_INFO_add_ext', LFailed);
    TS_TST_INFO_get_ext_d2i := LoadFunction('TS_TST_INFO_get_ext_d2i', LFailed);
    TS_RESP_CTX_new := LoadFunction('TS_RESP_CTX_new', LFailed);
    TS_RESP_CTX_free := LoadFunction('TS_RESP_CTX_free', LFailed);
    TS_RESP_CTX_set_signer_cert := LoadFunction('TS_RESP_CTX_set_signer_cert', LFailed);
    TS_RESP_CTX_set_signer_key := LoadFunction('TS_RESP_CTX_set_signer_key', LFailed);
    TS_RESP_CTX_set_signer_digest := LoadFunction('TS_RESP_CTX_set_signer_digest', LFailed);
    TS_RESP_CTX_set_ess_cert_id_digest := LoadFunction('TS_RESP_CTX_set_ess_cert_id_digest', LFailed);
    TS_RESP_CTX_set_def_policy := LoadFunction('TS_RESP_CTX_set_def_policy', LFailed);
    TS_RESP_CTX_add_policy := LoadFunction('TS_RESP_CTX_add_policy', LFailed);
    TS_RESP_CTX_add_md := LoadFunction('TS_RESP_CTX_add_md', LFailed);
    TS_RESP_CTX_set_accuracy := LoadFunction('TS_RESP_CTX_set_accuracy', LFailed);
    TS_RESP_CTX_set_clock_precision_digits := LoadFunction('TS_RESP_CTX_set_clock_precision_digits', LFailed);
    TS_RESP_CTX_add_flags := LoadFunction('TS_RESP_CTX_add_flags', LFailed);
    TS_RESP_CTX_set_serial_cb := LoadFunction('TS_RESP_CTX_set_serial_cb', LFailed);
    TS_RESP_CTX_set_time_cb := LoadFunction('TS_RESP_CTX_set_time_cb', LFailed);
    TS_RESP_CTX_set_extension_cb := LoadFunction('TS_RESP_CTX_set_extension_cb', LFailed);
    TS_RESP_CTX_set_status_info := LoadFunction('TS_RESP_CTX_set_status_info', LFailed);
    TS_RESP_CTX_set_status_info_cond := LoadFunction('TS_RESP_CTX_set_status_info_cond', LFailed);
    TS_RESP_CTX_add_failure_info := LoadFunction('TS_RESP_CTX_add_failure_info', LFailed);
    TS_RESP_CTX_get_request := LoadFunction('TS_RESP_CTX_get_request', LFailed);
    TS_RESP_CTX_get_tst_info := LoadFunction('TS_RESP_CTX_get_tst_info', LFailed);
    TS_RESP_create_response := LoadFunction('TS_RESP_create_response', LFailed);
    TS_RESP_verify_response := LoadFunction('TS_RESP_verify_response', LFailed);
    TS_RESP_verify_token := LoadFunction('TS_RESP_verify_token', LFailed);
    TS_VERIFY_CTX_new := LoadFunction('TS_VERIFY_CTX_new', LFailed);
    TS_VERIFY_CTX_init := LoadFunction('TS_VERIFY_CTX_init', LFailed);
    TS_VERIFY_CTX_free := LoadFunction('TS_VERIFY_CTX_free', LFailed);
    TS_VERIFY_CTX_cleanup := LoadFunction('TS_VERIFY_CTX_cleanup', LFailed);
    TS_VERIFY_CTX_set_flags := LoadFunction('TS_VERIFY_CTX_set_flags', LFailed);
    TS_VERIFY_CTX_add_flags := LoadFunction('TS_VERIFY_CTX_add_flags', LFailed);
    TS_VERIFY_CTX_set_data := LoadFunction('TS_VERIFY_CTX_set_data', LFailed);
    TS_VERIFY_CTX_set_imprint := LoadFunction('TS_VERIFY_CTX_set_imprint', LFailed);
    TS_VERIFY_CTX_set_store := LoadFunction('TS_VERIFY_CTX_set_store', LFailed);
    TS_REQ_to_TS_VERIFY_CTX := LoadFunction('TS_REQ_to_TS_VERIFY_CTX', LFailed);
    TS_RESP_print_bio := LoadFunction('TS_RESP_print_bio', LFailed);
    TS_STATUS_INFO_print_bio := LoadFunction('TS_STATUS_INFO_print_bio', LFailed);
    TS_TST_INFO_print_bio := LoadFunction('TS_TST_INFO_print_bio', LFailed);
    TS_ASN1_INTEGER_print_bio := LoadFunction('TS_ASN1_INTEGER_print_bio', LFailed);
    TS_OBJ_print_bio := LoadFunction('TS_OBJ_print_bio', LFailed);
    TS_X509_ALGOR_print_bio := LoadFunction('TS_X509_ALGOR_print_bio', LFailed);
    TS_MSG_IMPRINT_print_bio := LoadFunction('TS_MSG_IMPRINT_print_bio', LFailed);
    TS_CONF_load_cert := LoadFunction('TS_CONF_load_cert', LFailed);
    TS_CONF_load_key := LoadFunction('TS_CONF_load_key', LFailed);
    TS_CONF_set_serial := LoadFunction('TS_CONF_set_serial', LFailed);
    TS_CONF_get_tsa_section := LoadFunction('TS_CONF_get_tsa_section', LFailed);
    TS_CONF_set_crypto_device := LoadFunction('TS_CONF_set_crypto_device', LFailed);
    TS_CONF_set_default_engine := LoadFunction('TS_CONF_set_default_engine', LFailed);
    TS_CONF_set_signer_cert := LoadFunction('TS_CONF_set_signer_cert', LFailed);
    TS_CONF_set_certs := LoadFunction('TS_CONF_set_certs', LFailed);
    TS_CONF_set_signer_key := LoadFunction('TS_CONF_set_signer_key', LFailed);
    TS_CONF_set_signer_digest := LoadFunction('TS_CONF_set_signer_digest', LFailed);
    TS_CONF_set_def_policy := LoadFunction('TS_CONF_set_def_policy', LFailed);
    TS_CONF_set_policies := LoadFunction('TS_CONF_set_policies', LFailed);
    TS_CONF_set_digests := LoadFunction('TS_CONF_set_digests', LFailed);
    TS_CONF_set_accuracy := LoadFunction('TS_CONF_set_accuracy', LFailed);
    TS_CONF_set_clock_precision_digits := LoadFunction('TS_CONF_set_clock_precision_digits', LFailed);
    TS_CONF_set_ordering := LoadFunction('TS_CONF_set_ordering', LFailed);
    TS_CONF_set_tsa_name := LoadFunction('TS_CONF_set_tsa_name', LFailed);
    TS_CONF_set_ess_cert_id_chain := LoadFunction('TS_CONF_set_ess_cert_id_chain', LFailed);
    TS_CONF_set_ess_cert_id_digest := LoadFunction('TS_CONF_set_ess_cert_id_digest', LFailed);

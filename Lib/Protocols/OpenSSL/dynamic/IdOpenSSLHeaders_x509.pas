...
begin
  ...
  try
    X509_CRL_set_default_method := LoadFunction('X509_CRL_set_default_method', LFailed);
    X509_CRL_METHOD_free := LoadFunction('X509_CRL_METHOD_free', LFailed);
    X509_CRL_set_meth_data := LoadFunction('X509_CRL_set_meth_data', LFailed);
    X509_CRL_get_meth_data := LoadFunction('X509_CRL_get_meth_data', LFailed);
    X509_verify_cert_error_string := LoadFunction('X509_verify_cert_error_string', LFailed);
    X509_verify := LoadFunction('X509_verify', LFailed);
    X509_REQ_verify := LoadFunction('X509_REQ_verify', LFailed);
    X509_CRL_verify := LoadFunction('X509_CRL_verify', LFailed);
    NETSCAPE_SPKI_verify := LoadFunction('NETSCAPE_SPKI_verify', LFailed);
    NETSCAPE_SPKI_b64_decode := LoadFunction('NETSCAPE_SPKI_b64_decode', LFailed);
    NETSCAPE_SPKI_b64_encode := LoadFunction('NETSCAPE_SPKI_b64_encode', LFailed);
    NETSCAPE_SPKI_get_pubkey := LoadFunction('NETSCAPE_SPKI_get_pubkey', LFailed);
    NETSCAPE_SPKI_set_pubkey := LoadFunction('NETSCAPE_SPKI_set_pubkey', LFailed);
    NETSCAPE_SPKI_print := LoadFunction('NETSCAPE_SPKI_print', LFailed);
    X509_signature_dump := LoadFunction('X509_signature_dump', LFailed);
    X509_signature_print := LoadFunction('X509_signature_print', LFailed);
    X509_sign := LoadFunction('X509_sign', LFailed);
    X509_sign_ctx := LoadFunction('X509_sign_ctx', LFailed);
    X509_http_nbio := LoadFunction('X509_http_nbio', LFailed);
    X509_REQ_sign := LoadFunction('X509_REQ_sign', LFailed);
    X509_REQ_sign_ctx := LoadFunction('X509_REQ_sign_ctx', LFailed);
    X509_CRL_sign := LoadFunction('X509_CRL_sign', LFailed);
    X509_CRL_sign_ctx := LoadFunction('X509_CRL_sign_ctx', LFailed);
    X509_CRL_http_nbio := LoadFunction('X509_CRL_http_nbio', LFailed);
    NETSCAPE_SPKI_sign := LoadFunction('NETSCAPE_SPKI_sign', LFailed);
    X509_pubkey_digest := LoadFunction('X509_pubkey_digest', LFailed);
    X509_digest := LoadFunction('X509_digest', LFailed);
    X509_CRL_digest := LoadFunction('X509_CRL_digest', LFailed);
    X509_REQ_digest := LoadFunction('X509_REQ_digest', LFailed);
    X509_NAME_digest := LoadFunction('X509_NAME_digest', LFailed);
    d2i_X509_bio := LoadFunction('d2i_X509_bio', LFailed);
    i2d_X509_bio := LoadFunction('i2d_X509_bio', LFailed);
    d2i_X509_CRL_bio := LoadFunction('d2i_X509_CRL_bio', LFailed);
    i2d_X509_CRL_bio := LoadFunction('i2d_X509_CRL_bio', LFailed);
    d2i_X509_REQ_bio := LoadFunction('d2i_X509_REQ_bio', LFailed);
    i2d_X509_REQ_bio := LoadFunction('i2d_X509_REQ_bio', LFailed);
    d2i_RSAPrivateKey_bio := LoadFunction('d2i_RSAPrivateKey_bio', LFailed);
    i2d_RSAPrivateKey_bio := LoadFunction('i2d_RSAPrivateKey_bio', LFailed);
    d2i_RSAPublicKey_bio := LoadFunction('d2i_RSAPublicKey_bio', LFailed);
    i2d_RSAPublicKey_bio := LoadFunction('i2d_RSAPublicKey_bio', LFailed);
    d2i_RSA_PUBKEY_bio := LoadFunction('d2i_RSA_PUBKEY_bio', LFailed);
    i2d_RSA_PUBKEY_bio := LoadFunction('i2d_RSA_PUBKEY_bio', LFailed);
    d2i_DSA_PUBKEY_bio := LoadFunction('d2i_DSA_PUBKEY_bio', LFailed);
    i2d_DSA_PUBKEY_bio := LoadFunction('i2d_DSA_PUBKEY_bio', LFailed);
    d2i_DSAPrivateKey_bio := LoadFunction('d2i_DSAPrivateKey_bio', LFailed);
    i2d_DSAPrivateKey_bio := LoadFunction('i2d_DSAPrivateKey_bio', LFailed);
    d2i_EC_PUBKEY_bio := LoadFunction('d2i_EC_PUBKEY_bio', LFailed);
    i2d_EC_PUBKEY_bio := LoadFunction('i2d_EC_PUBKEY_bio', LFailed);
    d2i_ECPrivateKey_bio := LoadFunction('d2i_ECPrivateKey_bio', LFailed);
    i2d_ECPrivateKey_bio := LoadFunction('i2d_ECPrivateKey_bio', LFailed);
    d2i_PKCS8_bio := LoadFunction('d2i_PKCS8_bio', LFailed);
    i2d_PKCS8_bio := LoadFunction('i2d_PKCS8_bio', LFailed);
    d2i_PKCS8_PRIV_KEY_INFO_bio := LoadFunction('d2i_PKCS8_PRIV_KEY_INFO_bio', LFailed);
    i2d_PKCS8_PRIV_KEY_INFO_bio := LoadFunction('i2d_PKCS8_PRIV_KEY_INFO_bio', LFailed);
    i2d_PKCS8PrivateKeyInfo_bio := LoadFunction('i2d_PKCS8PrivateKeyInfo_bio', LFailed);
    i2d_PrivateKey_bio := LoadFunction('i2d_PrivateKey_bio', LFailed);
    ...
    X509_CRL_dup := LoadFunction('X509_CRL_dup', LFailed);
    X509_REVOKED_dup := LoadFunction('X509_REVOKED_dup', LFailed);
    X509_REQ_dup := LoadFunction('X509_REQ_dup', LFailed);
    X509_ALGOR_dup := LoadFunction('X509_ALGOR_dup', LFailed);
    X509_ALGOR_set0 := LoadFunction('X509_ALGOR_set0', LFailed);
    X509_ALGOR_get0 := LoadFunction('X509_ALGOR_get0', LFailed);
    X509_ALGOR_set_md := LoadFunction('X509_ALGOR_set_md', LFailed);
    ...
    X509_get_default_cert_dir_env := LoadFunction('X509_get_default_cert_dir_env', LFailed);
    X509_get_default_cert_file_env := LoadFunction('X509_get_default_cert_file_env', LFailed);
    ...
    X509_get_pathlen := LoadFunction('X509_get_pathlen', LFailed);
    i2d_PUBKEY := LoadFunction('i2d_PUBKEY', LFailed);
    d2i_PUBKEY := LoadFunction('d2i_PUBKEY', LFailed);
    i2d_RSA_PUBKEY := LoadFunction('i2d_RSA_PUBKEY', LFailed);
    d2i_RSA_PUBKEY := LoadFunction('d2i_RSA_PUBKEY', LFailed);
    i2d_DSA_PUBKEY := LoadFunction('i2d_DSA_PUBKEY', LFailed);
    ...
    d2i_X509_AUX := LoadFunction('d2i_X509_AUX', LFailed);
    i2d_re_X509_tbs := LoadFunction('i2d_re_X509_tbs', LFailed);
    X509_SIG_INFO_get := LoadFunction('X509_SIG_INFO_get', LFailed);
    X509_SIG_INFO_set := LoadFunction('X509_SIG_INFO_set', LFailed);
    X509_get_signature_info := LoadFunction('X509_get_signature_info', LFailed);
    X509_get0_signature := LoadFunction('X509_get0_signature', LFailed);
    X509_get_signature_nid := LoadFunction('X509_get_signature_nid', LFailed);
    X509_trusted := LoadFunction('X509_trusted', LFailed);
    X509_alias_set1 := LoadFunction('X509_alias_set1', LFailed);
    X509_keyid_set1 := LoadFunction('X509_keyid_set1', LFailed);
    X509_alias_get0 := LoadFunction('X509_alias_get0', LFailed);
    X509_keyid_get0 := LoadFunction('X509_keyid_get0', LFailed);
    X509_TRUST_set := LoadFunction('X509_TRUST_set', LFailed);
    X509_add1_trust_object := LoadFunction('X509_add1_trust_object', LFailed);
    ...
    X509_PKEY_new := LoadFunction('X509_PKEY_new', LFailed);
    X509_PKEY_free := LoadFunction('X509_PKEY_free', LFailed);
    X509_INFO_new := LoadFunction('X509_INFO_new', LFailed);
    X509_INFO_free := LoadFunction('X509_INFO_free', LFailed);
    X509_NAME_oneline := LoadFunction('X509_NAME_oneline', LFailed);
    ASN1_item_digest := LoadFunction('ASN1_item_digest', LFailed);
    ASN1_item_verify := LoadFunction('ASN1_item_verify', LFailed);
    ASN1_item_sign := LoadFunction('ASN1_item_sign', LFailed);
    ASN1_item_sign_ctx := LoadFunction('ASN1_item_sign_ctx', LFailed);
    X509_get_version := LoadFunction('X509_get_version', LFailed);
    X509_set_version := LoadFunction('X509_set_version', LFailed);
    X509_set_serialNumber := LoadFunction('X509_set_serialNumber', LFailed);
    X509_get_serialNumber := LoadFunction('X509_get_serialNumber', LFailed);
    X509_get0_serialNumber := LoadFunction('X509_get0_serialNumber', LFailed);
    X509_set_issuer_name := LoadFunction('X509_set_issuer_name', LFailed);
    X509_get_issuer_name := LoadFunction('X509_get_issuer_name', LFailed);
    X509_set_subject_name := LoadFunction('X509_set_subject_name', LFailed);
    X509_get_subject_name := LoadFunction('X509_get_subject_name', LFailed);
    X509_get0_notBefore := LoadFunction('X509_get0_notBefore', LFailed);
    X509_getm_notBefore := LoadFunction('X509_getm_notBefore', LFailed);
    X509_set1_notBefore := LoadFunction('X509_set1_notBefore', LFailed);
    X509_get0_notAfter := LoadFunction('X509_get0_notAfter', LFailed);
    X509_getm_notAfter := LoadFunction('X509_getm_notAfter', LFailed);
    X509_set1_notAfter := LoadFunction('X509_set1_notAfter', LFailed);
    X509_set_pubkey := LoadFunction('X509_set_pubkey', LFailed);
    X509_up_ref := LoadFunction('X509_up_ref', LFailed);
    X509_get_signature_type := LoadFunction('X509_get_signature_type', LFailed);
    X509_get_X509_PUBKEY := LoadFunction('X509_get_X509_PUBKEY', LFailed);
    X509_get0_uids := LoadFunction('X509_get0_uids', LFailed);
    X509_get0_tbs_sigalg := LoadFunction('X509_get0_tbs_sigalg', LFailed);
    X509_get0_pubkey := LoadFunction('X509_get0_pubkey', LFailed);
    X509_get_pubkey := LoadFunction('X509_get_pubkey', LFailed);
    X509_get0_pubkey_bitstr := LoadFunction('X509_get0_pubkey_bitstr', LFailed);
    X509_certificate_type := LoadFunction('X509_certificate_type', LFailed);
    X509_REQ_get_version := LoadFunction('X509_REQ_get_version', LFailed);
    X509_REQ_set_version := LoadFunction('X509_REQ_set_version', LFailed);
    X509_REQ_get_subject_name := LoadFunction('X509_REQ_get_subject_name', LFailed);
    X509_REQ_set_subject_name := LoadFunction('X509_REQ_set_subject_name', LFailed);
    X509_REQ_get0_signature := LoadFunction('X509_REQ_get0_signature', LFailed);
    X509_REQ_get_signature_nid := LoadFunction('X509_REQ_get_signature_nid', LFailed);
    i2d_re_X509_REQ_tbs := LoadFunction('i2d_re_X509_REQ_tbs', LFailed);
    X509_REQ_set_pubkey := LoadFunction('X509_REQ_set_pubkey', LFailed);
    X509_REQ_get_pubkey := LoadFunction('X509_REQ_get_pubkey', LFailed);
    X509_REQ_get0_pubkey := LoadFunction('X509_REQ_get0_pubkey', LFailed);
    X509_REQ_get_X509_PUBKEY := LoadFunction('X509_REQ_get_X509_PUBKEY', LFailed);
    X509_REQ_extension_nid := LoadFunction('X509_REQ_extension_nid', LFailed);
    X509_REQ_get_extension_nids := LoadFunction('X509_REQ_get_extension_nids', LFailed);
    X509_REQ_set_extension_nids := LoadFunction('X509_REQ_set_extension_nids', LFailed);
    X509_REQ_get_attr_count := LoadFunction('X509_REQ_get_attr_count', LFailed);
    X509_REQ_get_attr_by_NID := LoadFunction('X509_REQ_get_attr_by_NID', LFailed);
    X509_REQ_get_attr_by_OBJ := LoadFunction('X509_REQ_get_attr_by_OBJ', LFailed);
    X509_REQ_get_attr := LoadFunction('X509_REQ_get_attr', LFailed);
    X509_REQ_delete_attr := LoadFunction('X509_REQ_delete_attr', LFailed);
    X509_REQ_add1_attr := LoadFunction('X509_REQ_add1_attr', LFailed);
    X509_REQ_add1_attr_by_OBJ := LoadFunction('X509_REQ_add1_attr_by_OBJ', LFailed);
    X509_REQ_add1_attr_by_NID := LoadFunction('X509_REQ_add1_attr_by_NID', LFailed);
    X509_REQ_add1_attr_by_txt := LoadFunction('X509_REQ_add1_attr_by_txt', LFailed);
    X509_CRL_set_version := LoadFunction('X509_CRL_set_version', LFailed);
    X509_CRL_set_issuer_name := LoadFunction('X509_CRL_set_issuer_name', LFailed);
    X509_CRL_set1_lastUpdate := LoadFunction('X509_CRL_set1_lastUpdate', LFailed);
    X509_CRL_set1_nextUpdate := LoadFunction('X509_CRL_set1_nextUpdate', LFailed);
    X509_CRL_sort := LoadFunction('X509_CRL_sort', LFailed);
    X509_CRL_up_ref := LoadFunction('X509_CRL_up_ref', LFailed);
    X509_CRL_get_version := LoadFunction('X509_CRL_get_version', LFailed);
    X509_CRL_get0_lastUpdate := LoadFunction('X509_CRL_get0_lastUpdate', LFailed);
    X509_CRL_get0_nextUpdate := LoadFunction('X509_CRL_get0_nextUpdate', LFailed);
    X509_CRL_get_issuer := LoadFunction('X509_CRL_get_issuer', LFailed);
    X509_CRL_get0_signature := LoadFunction('X509_CRL_get0_signature', LFailed);
    X509_CRL_get_signature_nid := LoadFunction('X509_CRL_get_signature_nid', LFailed);
    i2d_re_X509_CRL_tbs := LoadFunction('i2d_re_X509_CRL_tbs', LFailed);
    X509_REVOKED_get0_serialNumber := LoadFunction('X509_REVOKED_get0_serialNumber', LFailed);
    X509_REVOKED_set_serialNumber := LoadFunction('X509_REVOKED_set_serialNumber', LFailed);
    X509_REVOKED_get0_revocationDate := LoadFunction('X509_REVOKED_get0_revocationDate', LFailed);
    X509_REVOKED_set_revocationDate := LoadFunction('X509_REVOKED_set_revocationDate', LFailed);
    X509_CRL_diff := LoadFunction('X509_CRL_diff', LFailed);
    X509_REQ_check_private_key := LoadFunction('X509_REQ_check_private_key', LFailed);
    X509_check_private_key := LoadFunction('X509_check_private_key', LFailed);
    X509_CRL_check_suiteb := LoadFunction('X509_CRL_check_suiteb', LFailed);
    X509_issuer_and_serial_cmp := LoadFunction('X509_issuer_and_serial_cmp', LFailed);
    X509_issuer_and_serial_hash := LoadFunction('X509_issuer_and_serial_hash', LFailed);
    X509_issuer_name_cmp := LoadFunction('X509_issuer_name_cmp', LFailed);
    X509_issuer_name_hash := LoadFunction('X509_issuer_name_hash', LFailed);
    X509_subject_name_cmp := LoadFunction('X509_subject_name_cmp', LFailed);
    X509_subject_name_hash := LoadFunction('X509_subject_name_hash', LFailed);
    X509_cmp := LoadFunction('X509_cmp', LFailed);
    X509_NAME_cmp := LoadFunction('X509_NAME_cmp', LFailed);
    X509_NAME_hash := LoadFunction('X509_NAME_hash', LFailed);
    X509_NAME_hash_old := LoadFunction('X509_NAME_hash_old', LFailed);
    X509_CRL_cmp := LoadFunction('X509_CRL_cmp', LFailed);
    X509_CRL_match := LoadFunction('X509_CRL_match', LFailed);
    X509_aux_print := LoadFunction('X509_aux_print', LFailed);
    X509_NAME_print := LoadFunction('X509_NAME_print', LFailed);
    X509_NAME_print_ex := LoadFunction('X509_NAME_print_ex', LFailed);
    X509_print_ex := LoadFunction('X509_print_ex', LFailed);
    X509_print := LoadFunction('X509_print', LFailed);
    X509_ocspid_print := LoadFunction('X509_ocspid_print', LFailed);
    X509_CRL_print_ex := LoadFunction('X509_CRL_print_ex', LFailed);
    X509_CRL_print := LoadFunction('X509_CRL_print', LFailed);
    X509_REQ_print_ex := LoadFunction('X509_REQ_print_ex', LFailed);
    X509_REQ_print := LoadFunction('X509_REQ_print', LFailed);
    X509_NAME_entry_count := LoadFunction('X509_NAME_entry_count', LFailed);
    X509_NAME_get_text_by_NID := LoadFunction('X509_NAME_get_text_by_NID', LFailed);
    X509_NAME_get_text_by_OBJ := LoadFunction('X509_NAME_get_text_by_OBJ', LFailed);
    X509_NAME_get_index_by_NID := LoadFunction('X509_NAME_get_index_by_NID', LFailed);
    X509_NAME_get_index_by_OBJ := LoadFunction('X509_NAME_get_index_by_OBJ', LFailed);
    X509_NAME_get_entry := LoadFunction('X509_NAME_get_entry', LFailed);
    X509_NAME_delete_entry := LoadFunction('X509_NAME_delete_entry', LFailed);
    X509_NAME_add_entry := LoadFunction('X509_NAME_add_entry', LFailed);
    X509_NAME_add_entry_by_OBJ := LoadFunction('X509_NAME_add_entry_by_OBJ', LFailed);
    X509_NAME_add_entry_by_NID := LoadFunction('X509_NAME_add_entry_by_NID', LFailed);
    X509_NAME_ENTRY_create_by_txt := LoadFunction('X509_NAME_ENTRY_create_by_txt', LFailed);
    X509_NAME_ENTRY_create_by_NID := LoadFunction('X509_NAME_ENTRY_create_by_NID', LFailed);
    X509_NAME_add_entry_by_txt := LoadFunction('X509_NAME_add_entry_by_txt', LFailed);
    X509_NAME_ENTRY_create_by_OBJ := LoadFunction('X509_NAME_ENTRY_create_by_OBJ', LFailed);
    X509_NAME_ENTRY_set_object := LoadFunction('X509_NAME_ENTRY_set_object', LFailed);
    X509_NAME_ENTRY_set_data := LoadFunction('X509_NAME_ENTRY_set_data', LFailed);
    X509_NAME_ENTRY_get_object := LoadFunction('X509_NAME_ENTRY_get_object', LFailed);
    X509_NAME_ENTRY_get_data := LoadFunction('X509_NAME_ENTRY_get_data', LFailed);
    X509_NAME_ENTRY_set := LoadFunction('X509_NAME_ENTRY_set', LFailed);
    X509_NAME_get0_der := LoadFunction('X509_NAME_get0_der', LFailed);
    X509_get_ext_count := LoadFunction('X509_get_ext_count', LFailed);
    X509_get_ext_by_NID := LoadFunction('X509_get_ext_by_NID', LFailed);
    X509_get_ext_by_OBJ := LoadFunction('X509_get_ext_by_OBJ', LFailed);
    X509_get_ext_by_critical := LoadFunction('X509_get_ext_by_critical', LFailed);
    X509_get_ext := LoadFunction('X509_get_ext', LFailed);
    X509_delete_ext := LoadFunction('X509_delete_ext', LFailed);
    X509_add_ext := LoadFunction('X509_add_ext', LFailed);
    X509_get_ext_d2i := LoadFunction('X509_get_ext_d2i', LFailed);
    X509_add1_ext_i2d := LoadFunction('X509_add1_ext_i2d', LFailed);
    X509_CRL_get_ext_count := LoadFunction('X509_CRL_get_ext_count', LFailed);
    X509_CRL_get_ext_by_NID := LoadFunction('X509_CRL_get_ext_by_NID', LFailed);
    X509_CRL_get_ext_by_OBJ := LoadFunction('X509_CRL_get_ext_by_OBJ', LFailed);
    X509_CRL_get_ext_by_critical := LoadFunction('X509_CRL_get_ext_by_critical', LFailed);
    X509_CRL_get_ext := LoadFunction('X509_CRL_get_ext', LFailed);
    X509_CRL_delete_ext := LoadFunction('X509_CRL_delete_ext', LFailed);
    X509_CRL_add_ext := LoadFunction('X509_CRL_add_ext', LFailed);
    X509_CRL_get_ext_d2i := LoadFunction('X509_CRL_get_ext_d2i', LFailed);
    X509_CRL_add1_ext_i2d := LoadFunction('X509_CRL_add1_ext_i2d', LFailed);
    X509_REVOKED_get_ext_count := LoadFunction('X509_REVOKED_get_ext_count', LFailed);
    X509_REVOKED_get_ext_by_NID := LoadFunction('X509_REVOKED_get_ext_by_NID', LFailed);
    X509_REVOKED_get_ext_by_OBJ := LoadFunction('X509_REVOKED_get_ext_by_OBJ', LFailed);
    X509_REVOKED_get_ext_by_critical := LoadFunction('X509_REVOKED_get_ext_by_critical', LFailed);
    X509_REVOKED_get_ext := LoadFunction('X509_REVOKED_get_ext', LFailed);
    X509_REVOKED_delete_ext := LoadFunction('X509_REVOKED_delete_ext', LFailed);
    X509_REVOKED_add_ext := LoadFunction('X509_REVOKED_add_ext', LFailed);
    X509_REVOKED_get_ext_d2i := LoadFunction('X509_REVOKED_get_ext_d2i', LFailed);
    X509_REVOKED_add1_ext_i2d := LoadFunction('X509_REVOKED_add1_ext_i2d', LFailed);
    X509_EXTENSION_create_by_NID := LoadFunction('X509_EXTENSION_create_by_NID', LFailed);
    X509_EXTENSION_create_by_OBJ := LoadFunction('X509_EXTENSION_create_by_OBJ', LFailed);
    X509_EXTENSION_set_object := LoadFunction('X509_EXTENSION_set_object', LFailed);
    X509_EXTENSION_set_critical := LoadFunction('X509_EXTENSION_set_critical', LFailed);
    X509_EXTENSION_set_data := LoadFunction('X509_EXTENSION_set_data', LFailed);
    X509_EXTENSION_get_object := LoadFunction('X509_EXTENSION_get_object', LFailed);
    X509_EXTENSION_get_data := LoadFunction('X509_EXTENSION_get_data', LFailed);
    X509_EXTENSION_get_critical := LoadFunction('X509_EXTENSION_get_critical', LFailed);
    X509_ATTRIBUTE_create_by_NID := LoadFunction('X509_ATTRIBUTE_create_by_NID', LFailed);
    X509_ATTRIBUTE_create_by_OBJ := LoadFunction('X509_ATTRIBUTE_create_by_OBJ', LFailed);
    X509_ATTRIBUTE_create_by_txt := LoadFunction('X509_ATTRIBUTE_create_by_txt', LFailed);
    X509_ATTRIBUTE_set1_object := LoadFunction('X509_ATTRIBUTE_set1_object', LFailed);
    X509_ATTRIBUTE_set1_data := LoadFunction('X509_ATTRIBUTE_set1_data', LFailed);
    X509_ATTRIBUTE_get0_data := LoadFunction('X509_ATTRIBUTE_get0_data', LFailed);
    X509_ATTRIBUTE_count := LoadFunction('X509_ATTRIBUTE_count', LFailed);
    X509_ATTRIBUTE_get0_object := LoadFunction('X509_ATTRIBUTE_get0_object', LFailed);
    X509_ATTRIBUTE_get0_type := LoadFunction('X509_ATTRIBUTE_get0_type', LFailed);
    EVP_PKEY_get_attr_count := LoadFunction('EVP_PKEY_get_attr_count', LFailed);
    EVP_PKEY_get_attr_by_NID := LoadFunction('EVP_PKEY_get_attr_by_NID', LFailed);
    EVP_PKEY_get_attr_by_OBJ := LoadFunction('EVP_PKEY_get_attr_by_OBJ', LFailed);
    EVP_PKEY_get_attr := LoadFunction('EVP_PKEY_get_attr', LFailed);
    EVP_PKEY_delete_attr := LoadFunction('EVP_PKEY_delete_attr', LFailed);
    EVP_PKEY_add1_attr := LoadFunction('EVP_PKEY_add1_attr', LFailed);
    EVP_PKEY_add1_attr_by_OBJ := LoadFunction('EVP_PKEY_add1_attr_by_OBJ', LFailed);
    EVP_PKEY_add1_attr_by_NID := LoadFunction('EVP_PKEY_add1_attr_by_NID', LFailed);
    EVP_PKEY_add1_attr_by_txt := LoadFunction('EVP_PKEY_add1_attr_by_txt', LFailed);
    X509_verify_cert := LoadFunction('X509_verify_cert', LFailed);
    PKCS5_pbe_set0_algor := LoadFunction('PKCS5_pbe_set0_algor', LFailed);
    PKCS5_pbe_set := LoadFunction('PKCS5_pbe_set', LFailed);
    PKCS5_pbe2_set := LoadFunction('PKCS5_pbe2_set', LFailed);
    PKCS5_pbe2_set_iv := LoadFunction('PKCS5_pbe2_set_iv', LFailed);
    PKCS5_pbe2_set_scrypt := LoadFunction('PKCS5_pbe2_set_scrypt', LFailed);
    PKCS5_pbkdf2_set := LoadFunction('PKCS5_pbkdf2_set', LFailed);
    EVP_PKCS82PKEY := LoadFunction('EVP_PKCS82PKEY', LFailed);
    EVP_PKEY2PKCS8 := LoadFunction('EVP_PKEY2PKCS8', LFailed);
    PKCS8_pkey_set0 := LoadFunction('PKCS8_pkey_set0', LFailed);
    PKCS8_pkey_get0 := LoadFunction('PKCS8_pkey_get0', LFailed);
    PKCS8_pkey_add1_attr_by_NID := LoadFunction('PKCS8_pkey_add1_attr_by_NID', LFailed);
    X509_PUBKEY_set0_param := LoadFunction('X509_PUBKEY_set0_param', LFailed);
    X509_PUBKEY_get0_param := LoadFunction('X509_PUBKEY_get0_param', LFailed);
    X509_check_trust := LoadFunction('X509_check_trust', LFailed);
    X509_TRUST_get_count := LoadFunction('X509_TRUST_get_count', LFailed);
    X509_TRUST_get0 := LoadFunction('X509_TRUST_get0', LFailed);
    X509_TRUST_get_by_id := LoadFunction('X509_TRUST_get_by_id', LFailed);
    X509_TRUST_cleanup := LoadFunction('X509_TRUST_cleanup', LFailed);
    X509_TRUST_get_flags := LoadFunction('X509_TRUST_get_flags', LFailed);
    X509_TRUST_get0_name := LoadFunction('X509_TRUST_get0_name', LFailed);
    X509_TRUST_get_trust := LoadFunction('X509_TRUST_get_trust', LFailed);

...
// DECLARE_ASN1_FUNCTIONS_fname(ASN1_TYPE, ASN1_ANY, ASN1_TYPE)
  ...
  ASN1_UTCTIME_set: function(s: PASN1_UTCTIME; t: time_t): PASN1_UTCTIME cdecl = nil;
  ASN1_UTCTIME_adj: function(s: PASN1_UTCTIME; t: time_t; offset_day: TIdC_INT; offset_sec: TIdC_LONG): PASN1_UTCTIME cdecl = nil;
  ASN1_UTCTIME_set_string: function(s: PASN1_UTCTIME; const str: PAnsiChar): TIdC_INT cdecl = nil;
  ASN1_UTCTIME_cmp_time_t: function(const s: PASN1_UTCTIME; t: time_t): TIdC_INT cdecl = nil;

  ASN1_GENERALIZEDTIME_check: function(const a: PASN1_GENERALIZEDTIME): TIdC_INT cdecl = nil;
  ASN1_GENERALIZEDTIME_set: function(s: PASN1_GENERALIZEDTIME; t: time_t): PASN1_GENERALIZEDTIME cdecl = nil;
  ASN1_GENERALIZEDTIME_adj: function(s: PASN1_GENERALIZEDTIME; t: time_t; offset_day: TIdC_INT; offset_sec: TIdC_LONG): PASN1_GENERALIZEDTIME cdecl = nil;
  ...
  ASN1_TIME_set: function(s: PASN1_TIME; t: time_t): PASN1_TIME cdecl = nil;
  ASN1_TIME_adj: function(s: PASN1_TIME; t: time_t; offset_day: TIdC_INT; offset_sec: TIdC_LONG): PASN1_TIME cdecl = nil;
  ...
  ASN1_TIME_cmp_time_t: function(const s: PASN1_TIME; t: time_t): TIdC_INT cdecl = nil;
  ...
  ASN1_buf_print: function(bp: PBIO; const buf: PByte; buflen: size_t; off: TIdC_INT): TIdC_INT cdecl = nil;
  ...
  ASN1_ITEM_get: function(i: size_t): PASN1_ITEM cdecl = nil;

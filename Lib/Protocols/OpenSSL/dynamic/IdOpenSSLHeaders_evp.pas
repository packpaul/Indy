...
var
  ...
  EVP_DigestUpdate: function(ctx: PEVP_MD_CTX; const d: Pointer; cnt: size_t): TIdC_INT cdecl = nil;
  EVP_DigestFinal_ex: function(ctx: PEVP_MD_CTX; md: PByte; s: PIdC_UINT): TIdC_INT cdecl = nil;
  EVP_Digest: function(const data: Pointer; count: size_t; md: PByte; size: PIdC_UINT; const &type: PEVP_MD; impl: PENGINE): TIdC_INT cdecl = nil;
  ...
  EVP_DigestFinalXOF: function(ctx: PEVP_MD_CTX; md: PByte; len: size_t): TIdC_INT cdecl = nil;
  ...
  EVP_DigestSign: function(ctx: PEVP_CIPHER_CTX; sigret: PByte; siglen: PSize_t; const tbs: PByte; tbslen: size_t): TIdC_INT cdecl = nil;

  EVP_VerifyFinal: function(ctx: PEVP_MD_CTX; const sigbuf: PByte; siglen: TIdC_UINT; pkey: PEVP_PKEY): TIdC_INT cdecl = nil;

  EVP_DigestVerify: function(ctx: PEVP_CIPHER_CTX; const sigret: PByte; siglen: size_t; const tbs: PByte; tbslen: size_t): TIdC_INT cdecl = nil;
  ...
  EVP_DigestSignFinal: function(ctx: PEVP_CIPHER_CTX; sigret: PByte; siglen: PSize_t): TIdC_INT cdecl = nil;
  ...
  EVP_DigestVerifyFinal: function(ctx: PEVP_MD_CTX; const sig: PByte; siglen: size_t): TIdC_INT cdecl = nil;
  ...
  EVP_PKEY_get0_hmac: function(const pkey: PEVP_PKEY; len: PSize_t): PByte cdecl = nil;
  EVP_PKEY_get0_poly1305: function(const pkey: PEVP_PKEY; len: PSize_t): PByte cdecl = nil;
  EVP_PKEY_get0_siphash: function(const pkey: PEVP_PKEY; len: PSize_t): PByte cdecl = nil;
  ...
  EVP_PKEY_set1_tls_encodedpoint: function(pkey: PEVP_PKEY; const pt: PByte; ptlen: size_t): TIdC_INT cdecl = nil;
  EVP_PKEY_get1_tls_encodedpoint: function(pkey: PEVP_PKEY; ppt: PPByte): size_t cdecl = nil;
  ...
  EVP_PBE_scrypt: function(const pass: PIdAnsiChar; passlen: size_t; const salt: PByte; saltlen: size_t; N: TIdC_UINT64; r: TIdC_UINT64; p: TIdC_UINT64; maxmem: TIdC_UINT64; key: PByte; keylen: size_t): TIdC_INT cdecl = nil;
  ...
  EVP_PBE_get: function(ptype: PIdC_INT; ppbe_nid: PIdC_INT; num: size_t): TIdC_INT cdecl = nil;
  ...
  EVP_PKEY_meth_get_count: function: size_t cdecl = nil;
  EVP_PKEY_meth_get0: function(idx: size_t): PEVP_PKEY_METHOD cdecl = nil;
  ...
  EVP_PKEY_new_raw_private_key: function(&type: TIdC_INT; e: PENGINE; const priv: PByte; len: size_t): PEVP_PKEY cdecl = nil;
  EVP_PKEY_new_raw_public_key: function(&type: TIdC_INT; e: PENGINE; const pub: PByte; len: size_t): PEVP_PKEY cdecl = nil;
  EVP_PKEY_get_raw_private_key: function(const pkey: PEVP_PKEY; priv: PByte; len: PSize_t): TIdC_INT cdecl = nil;
  EVP_PKEY_get_raw_public_key: function(const pkey: PEVP_PKEY; pub: PByte; len: PSize_t): TIdC_INT cdecl = nil;

  EVP_PKEY_new_CMAC_key: function(e: PENGINE; const priv: PByte; len: size_t; const cipher: PEVP_CIPHER): PEVP_PKEY cdecl = nil;
  ...
  EVP_PKEY_sign: function(ctx: PEVP_PKEY_CTX; sig: PByte; siglen: PSize_t; const tbs: PByte; tbslen: size_t): TIdC_INT cdecl = nil;
  EVP_PKEY_verify_init: function(ctx: PEVP_PKEY_CTX): TIdC_INT cdecl = nil;
  EVP_PKEY_verify: function(ctx: PEVP_PKEY_CTX; const sig: PByte; siglen: size_t; const tbs: PByte; tbslen: size_t): TIdC_INT cdecl = nil;
  EVP_PKEY_verify_recover_init: function(ctx: PEVP_PKEY_CTX): TIdC_INT cdecl = nil;
  EVP_PKEY_verify_recover: function(ctx: PEVP_PKEY_CTX; rout: PByte; routlen: PSize_t; const sig: PByte; siglen: size_t): TIdC_INT cdecl = nil;
  EVP_PKEY_encrypt_init: function(ctx: PEVP_PKEY_CTX): TIdC_INT cdecl = nil;
  EVP_PKEY_encrypt: function(ctx: PEVP_PKEY_CTX; &out: PByte; outlen: PSize_t; const &in: PByte; inlen: size_t): TIdC_INT cdecl = nil;
  EVP_PKEY_decrypt_init: function(ctx: PEVP_PKEY_CTX): TIdC_INT cdecl = nil;
  EVP_PKEY_decrypt: function(ctx: PEVP_PKEY_CTX; &out: PByte; outlen: PSize_t; const &in: PByte; inlen: size_t): TIdC_INT cdecl = nil;
  ...
  EVP_PKEY_derive: function(ctx: PEVP_PKEY_CTX; key: PByte; keylen: PSize_t): TIdC_INT cdecl = nil;
...
begin
  ...
  try
    EVP_MD_meth_new := LoadFunction('EVP_MD_meth_new', LFailed);
    EVP_MD_meth_dup := LoadFunction('EVP_MD_meth_dup', LFailed);
    EVP_MD_meth_free := LoadFunction('EVP_MD_meth_free', LFailed);
    EVP_MD_meth_set_input_blocksize := LoadFunction('EVP_MD_meth_set_input_blocksize', LFailed);
    EVP_MD_meth_set_result_size := LoadFunction('EVP_MD_meth_set_result_size', LFailed);
    EVP_MD_meth_set_app_datasize := LoadFunction('EVP_MD_meth_set_app_datasize', LFailed);
    EVP_MD_meth_set_flags := LoadFunction('EVP_MD_meth_set_flags', LFailed);
    EVP_MD_meth_set_init := LoadFunction('EVP_MD_meth_set_init', LFailed);
    EVP_MD_meth_set_update := LoadFunction('EVP_MD_meth_set_update', LFailed);
    EVP_MD_meth_set_final := LoadFunction('EVP_MD_meth_set_final', LFailed);
    EVP_MD_meth_set_copy := LoadFunction('EVP_MD_meth_set_copy', LFailed);
    EVP_MD_meth_set_cleanup := LoadFunction('EVP_MD_meth_set_cleanup', LFailed);
    EVP_MD_meth_set_ctrl := LoadFunction('EVP_MD_meth_set_ctrl', LFailed);
    EVP_MD_meth_get_input_blocksize := LoadFunction('EVP_MD_meth_get_input_blocksize', LFailed);
    EVP_MD_meth_get_result_size := LoadFunction('EVP_MD_meth_get_result_size', LFailed);
    EVP_MD_meth_get_app_datasize := LoadFunction('EVP_MD_meth_get_app_datasize', LFailed);
    EVP_MD_meth_get_flags := LoadFunction('EVP_MD_meth_get_flags', LFailed);
    EVP_MD_meth_get_init := LoadFunction('EVP_MD_meth_get_init', LFailed);
    EVP_MD_meth_get_update := LoadFunction('EVP_MD_meth_get_update', LFailed);
    EVP_MD_meth_get_final := LoadFunction('EVP_MD_meth_get_final', LFailed);
    EVP_MD_meth_get_copy := LoadFunction('EVP_MD_meth_get_copy', LFailed);
    EVP_MD_meth_get_cleanup := LoadFunction('EVP_MD_meth_get_cleanup', LFailed);
    EVP_MD_meth_get_ctrl := LoadFunction('EVP_MD_meth_get_ctrl', LFailed);
    EVP_CIPHER_meth_new := LoadFunction('EVP_CIPHER_meth_new', LFailed);
    EVP_CIPHER_meth_dup := LoadFunction('EVP_CIPHER_meth_dup', LFailed);
    EVP_CIPHER_meth_free := LoadFunction('EVP_CIPHER_meth_free', LFailed);
    EVP_CIPHER_meth_set_iv_length := LoadFunction('EVP_CIPHER_meth_set_iv_length', LFailed);
    EVP_CIPHER_meth_set_flags := LoadFunction('EVP_CIPHER_meth_set_flags', LFailed);
    EVP_CIPHER_meth_set_impl_ctx_size := LoadFunction('EVP_CIPHER_meth_set_impl_ctx_size', LFailed);
    EVP_CIPHER_meth_set_init := LoadFunction('EVP_CIPHER_meth_set_init', LFailed);
    EVP_CIPHER_meth_set_do_cipher := LoadFunction('EVP_CIPHER_meth_set_do_cipher', LFailed);
    EVP_CIPHER_meth_set_cleanup := LoadFunction('EVP_CIPHER_meth_set_cleanup', LFailed);
    EVP_CIPHER_meth_set_set_asn1_params := LoadFunction('EVP_CIPHER_meth_set_set_asn1_params', LFailed);
    EVP_CIPHER_meth_set_get_asn1_params := LoadFunction('EVP_CIPHER_meth_set_get_asn1_params', LFailed);
    EVP_CIPHER_meth_set_ctrl := LoadFunction('EVP_CIPHER_meth_set_ctrl', LFailed);
    EVP_CIPHER_meth_get_init := LoadFunction('EVP_CIPHER_meth_get_init', LFailed);
    EVP_CIPHER_meth_get_do_cipher := LoadFunction('EVP_CIPHER_meth_get_do_cipher', LFailed);
    EVP_CIPHER_meth_get_cleanup := LoadFunction('EVP_CIPHER_meth_get_cleanup', LFailed);
    EVP_CIPHER_meth_get_set_asn1_params := LoadFunction('EVP_CIPHER_meth_get_set_asn1_params', LFailed);
    EVP_CIPHER_meth_get_get_asn1_params := LoadFunction('EVP_CIPHER_meth_get_get_asn1_params', LFailed);
    EVP_CIPHER_meth_get_ctrl := LoadFunction('EVP_CIPHER_meth_get_ctrl', LFailed);
    EVP_MD_type := LoadFunction('EVP_MD_type', LFailed);
    EVP_MD_pkey_type := LoadFunction('EVP_MD_pkey_type', LFailed);
    EVP_MD_size := LoadFunction('EVP_MD_size', LFailed);
    EVP_MD_block_size := LoadFunction('EVP_MD_block_size', LFailed);
    EVP_MD_flags := LoadFunction('EVP_MD_flags', LFailed);
    EVP_MD_CTX_md := LoadFunction('EVP_MD_CTX_md', LFailed);
    EVP_MD_CTX_update_fn := LoadFunction('EVP_MD_CTX_update_fn', LFailed);
    EVP_MD_CTX_set_update_fn := LoadFunction('EVP_MD_CTX_set_update_fn', LFailed);
    EVP_MD_CTX_pkey_ctx := LoadFunction('EVP_MD_CTX_pkey_ctx', LFailed);
    EVP_MD_CTX_set_pkey_ctx := LoadFunction('EVP_MD_CTX_set_pkey_ctx', LFailed);
    EVP_MD_CTX_md_data := LoadFunction('EVP_MD_CTX_md_data', LFailed);
    EVP_CIPHER_nid := LoadFunction('EVP_CIPHER_nid', LFailed);
    EVP_CIPHER_block_size := LoadFunction('EVP_CIPHER_block_size', LFailed);
    EVP_CIPHER_impl_ctx_size := LoadFunction('EVP_CIPHER_impl_ctx_size', LFailed);
    EVP_CIPHER_key_length := LoadFunction('EVP_CIPHER_key_length', LFailed);
    EVP_CIPHER_iv_length := LoadFunction('EVP_CIPHER_iv_length', LFailed);
    EVP_CIPHER_flags := LoadFunction('EVP_CIPHER_flags', LFailed);
    EVP_CIPHER_CTX_cipher := LoadFunction('EVP_CIPHER_CTX_cipher', LFailed);
    EVP_CIPHER_CTX_encrypting := LoadFunction('EVP_CIPHER_CTX_encrypting', LFailed);
    EVP_CIPHER_CTX_nid := LoadFunction('EVP_CIPHER_CTX_nid', LFailed);
    EVP_CIPHER_CTX_block_size := LoadFunction('EVP_CIPHER_CTX_block_size', LFailed);
    EVP_CIPHER_CTX_key_length := LoadFunction('EVP_CIPHER_CTX_key_length', LFailed);
    EVP_CIPHER_CTX_iv_length := LoadFunction('EVP_CIPHER_CTX_iv_length', LFailed);
    EVP_CIPHER_CTX_iv := LoadFunction('EVP_CIPHER_CTX_iv', LFailed);
    EVP_CIPHER_CTX_original_iv := LoadFunction('EVP_CIPHER_CTX_original_iv', LFailed);
    EVP_CIPHER_CTX_iv_noconst := LoadFunction('EVP_CIPHER_CTX_iv_noconst', LFailed);
    EVP_CIPHER_CTX_buf_noconst := LoadFunction('EVP_CIPHER_CTX_buf_noconst', LFailed);
    EVP_CIPHER_CTX_num := LoadFunction('EVP_CIPHER_CTX_num', LFailed);
    EVP_CIPHER_CTX_set_num := LoadFunction('EVP_CIPHER_CTX_set_num', LFailed);
    EVP_CIPHER_CTX_copy := LoadFunction('EVP_CIPHER_CTX_copy', LFailed);
    EVP_CIPHER_CTX_get_app_data := LoadFunction('EVP_CIPHER_CTX_get_app_data', LFailed);
    EVP_CIPHER_CTX_set_app_data := LoadFunction('EVP_CIPHER_CTX_set_app_data', LFailed);
    EVP_CIPHER_CTX_get_cipher_data := LoadFunction('EVP_CIPHER_CTX_get_cipher_data', LFailed);
    EVP_CIPHER_CTX_set_cipher_data := LoadFunction('EVP_CIPHER_CTX_set_cipher_data', LFailed);
    BIO_set_md := LoadFunction('BIO_set_md', LFailed);
    EVP_MD_CTX_ctrl := LoadFunction('EVP_MD_CTX_ctrl', LFailed);
    EVP_MD_CTX_new := LoadFunction('EVP_MD_CTX_new', LFailed);
    EVP_MD_CTX_reset := LoadFunction('EVP_MD_CTX_reset', LFailed);
    EVP_MD_CTX_free := LoadFunction('EVP_MD_CTX_free', LFailed);
    EVP_MD_CTX_copy_ex := LoadFunction('EVP_MD_CTX_copy_ex', LFailed);
    EVP_MD_CTX_set_flags := LoadFunction('EVP_MD_CTX_set_flags', LFailed);
    EVP_MD_CTX_clear_flags := LoadFunction('EVP_MD_CTX_clear_flags', LFailed);
    EVP_MD_CTX_test_flags := LoadFunction('EVP_MD_CTX_test_flags', LFailed);
    EVP_DigestInit_ex := LoadFunction('EVP_DigestInit_ex', LFailed);
    EVP_DigestUpdate := LoadFunction('EVP_DigestUpdate', LFailed);
    EVP_DigestFinal_ex := LoadFunction('EVP_DigestFinal_ex', LFailed);
    EVP_Digest := LoadFunction('EVP_Digest', LFailed);
    EVP_MD_CTX_copy := LoadFunction('EVP_MD_CTX_copy', LFailed);
    EVP_DigestInit := LoadFunction('EVP_DigestInit', LFailed);
    EVP_DigestFinal := LoadFunction('EVP_DigestFinal', LFailed);
    EVP_DigestFinalXOF := LoadFunction('EVP_DigestFinalXOF', LFailed);
    EVP_read_pw_string := LoadFunction('EVP_read_pw_string', LFailed);
    EVP_read_pw_string_min := LoadFunction('EVP_read_pw_string_min', LFailed);
    EVP_set_pw_prompt := LoadFunction('EVP_set_pw_prompt', LFailed);
    EVP_get_pw_prompt := LoadFunction('EVP_get_pw_prompt', LFailed);
    EVP_BytesToKey := LoadFunction('EVP_BytesToKey', LFailed);
    EVP_CIPHER_CTX_set_flags := LoadFunction('EVP_CIPHER_CTX_set_flags', LFailed);
    EVP_CIPHER_CTX_clear_flags := LoadFunction('EVP_CIPHER_CTX_clear_flags', LFailed);
    EVP_CIPHER_CTX_test_flags := LoadFunction('EVP_CIPHER_CTX_test_flags', LFailed);
    EVP_EncryptInit := LoadFunction('EVP_EncryptInit', LFailed);
    EVP_EncryptInit_ex := LoadFunction('EVP_EncryptInit_ex', LFailed);
    EVP_EncryptUpdate := LoadFunction('EVP_EncryptUpdate', LFailed);
    EVP_EncryptFinal_ex := LoadFunction('EVP_EncryptFinal_ex', LFailed);
    EVP_EncryptFinal := LoadFunction('EVP_EncryptFinal', LFailed);
    EVP_DecryptInit := LoadFunction('EVP_DecryptInit', LFailed);
    EVP_DecryptInit_ex := LoadFunction('EVP_DecryptInit_ex', LFailed);
    EVP_DecryptUpdate := LoadFunction('EVP_DecryptUpdate', LFailed);
    EVP_DecryptFinal := LoadFunction('EVP_DecryptFinal', LFailed);
    EVP_DecryptFinal_ex := LoadFunction('EVP_DecryptFinal_ex', LFailed);
    EVP_CipherInit := LoadFunction('EVP_CipherInit', LFailed);
    EVP_CipherInit_ex := LoadFunction('EVP_CipherInit_ex', LFailed);
    EVP_CipherUpdate := LoadFunction('EVP_CipherUpdate', LFailed);
    EVP_CipherFinal := LoadFunction('EVP_CipherFinal', LFailed);
    EVP_CipherFinal_ex := LoadFunction('EVP_CipherFinal_ex', LFailed);
    EVP_SignFinal := LoadFunction('EVP_SignFinal', LFailed);
    EVP_DigestSign := LoadFunction('EVP_DigestSign', LFailed);
    EVP_VerifyFinal := LoadFunction('EVP_VerifyFinal', LFailed);
    EVP_DigestVerify := LoadFunction('EVP_DigestVerify', LFailed);
    EVP_DigestSignInit := LoadFunction('EVP_DigestSignInit', LFailed);
    EVP_DigestSignFinal := LoadFunction('EVP_DigestSignFinal', LFailed);
    EVP_DigestVerifyInit := LoadFunction('EVP_DigestVerifyInit', LFailed);
    EVP_DigestVerifyFinal := LoadFunction('EVP_DigestVerifyFinal', LFailed);
    EVP_OpenInit := LoadFunction('EVP_OpenInit', LFailed);
    EVP_OpenFinal := LoadFunction('EVP_OpenFinal', LFailed);
    EVP_SealInit := LoadFunction('EVP_SealInit', LFailed);
    EVP_SealFinal := LoadFunction('EVP_SealFinal', LFailed);
    EVP_ENCODE_CTX_new := LoadFunction('EVP_ENCODE_CTX_new', LFailed);
    EVP_ENCODE_CTX_free := LoadFunction('EVP_ENCODE_CTX_free', LFailed);
    EVP_ENCODE_CTX_copy := LoadFunction('EVP_ENCODE_CTX_copy', LFailed);
    EVP_ENCODE_CTX_num := LoadFunction('EVP_ENCODE_CTX_num', LFailed);
    EVP_EncodeInit := LoadFunction('EVP_EncodeInit', LFailed);
    EVP_EncodeUpdate := LoadFunction('EVP_EncodeUpdate', LFailed);
    EVP_EncodeFinal := LoadFunction('EVP_EncodeFinal', LFailed);
    EVP_EncodeBlock := LoadFunction('EVP_EncodeBlock', LFailed);
    EVP_DecodeInit := LoadFunction('EVP_DecodeInit', LFailed);
    EVP_DecodeUpdate := LoadFunction('EVP_DecodeUpdate', LFailed);
    EVP_DecodeFinal := LoadFunction('EVP_DecodeFinal', LFailed);
    EVP_DecodeBlock := LoadFunction('EVP_DecodeBlock', LFailed);
    EVP_CIPHER_CTX_new := LoadFunction('EVP_CIPHER_CTX_new', LFailed);
    EVP_CIPHER_CTX_reset := LoadFunction('EVP_CIPHER_CTX_reset', LFailed);
    EVP_CIPHER_CTX_free := LoadFunction('EVP_CIPHER_CTX_free', LFailed);
    EVP_CIPHER_CTX_set_key_length := LoadFunction('EVP_CIPHER_CTX_set_key_length', LFailed);
    EVP_CIPHER_CTX_set_padding := LoadFunction('EVP_CIPHER_CTX_set_padding', LFailed);
    EVP_CIPHER_CTX_ctrl := LoadFunction('EVP_CIPHER_CTX_ctrl', LFailed);
    EVP_CIPHER_CTX_rand_key := LoadFunction('EVP_CIPHER_CTX_rand_key', LFailed);
    BIO_f_md := LoadFunction('BIO_f_md', LFailed);
    BIO_f_base64 := LoadFunction('BIO_f_base64', LFailed);
    BIO_f_cipher := LoadFunction('BIO_f_cipher', LFailed);
    BIO_f_reliable := LoadFunction('BIO_f_reliable', LFailed);
    BIO_set_cipher := LoadFunction('BIO_set_cipher', LFailed);
    EVP_md_null := LoadFunction('EVP_md_null', LFailed);
    EVP_md5 := LoadFunction('EVP_md5', LFailed);
    EVP_md5_sha1 := LoadFunction('EVP_md5_sha1', LFailed);
    EVP_sha1 := LoadFunction('EVP_sha1', LFailed);
    EVP_sha224 := LoadFunction('EVP_sha224', LFailed);
    EVP_sha256 := LoadFunction('EVP_sha256', LFailed);
    EVP_sha384 := LoadFunction('EVP_sha384', LFailed);
    EVP_sha512 := LoadFunction('EVP_sha512', LFailed);
    EVP_sha512_224 := LoadFunction('EVP_sha512_224', LFailed);
    EVP_sha512_256 := LoadFunction('EVP_sha512_256', LFailed);
    EVP_sha3_224 := LoadFunction('EVP_sha3_224', LFailed);
    EVP_sha3_256 := LoadFunction('EVP_sha3_256', LFailed);
    EVP_sha3_384 := LoadFunction('EVP_sha3_384', LFailed);
    EVP_sha3_512 := LoadFunction('EVP_sha3_512', LFailed);
    EVP_shake128 := LoadFunction('EVP_shake128', LFailed);
    EVP_shake256 := LoadFunction('EVP_shake256', LFailed);
    EVP_enc_null := LoadFunction('EVP_enc_null', LFailed);
    EVP_des_ecb := LoadFunction('EVP_des_ecb', LFailed);
    EVP_des_ede := LoadFunction('EVP_des_ede', LFailed);
    EVP_des_ede3 := LoadFunction('EVP_des_ede3', LFailed);
    EVP_des_ede_ecb := LoadFunction('EVP_des_ede_ecb', LFailed);
    EVP_des_ede3_ecb := LoadFunction('EVP_des_ede3_ecb', LFailed);
    EVP_des_cfb64 := LoadFunction('EVP_des_cfb64', LFailed);
    EVP_des_cfb1 := LoadFunction('EVP_des_cfb1', LFailed);
    EVP_des_cfb8 := LoadFunction('EVP_des_cfb8', LFailed);
    EVP_des_ede_cfb64 := LoadFunction('EVP_des_ede_cfb64', LFailed);
    EVP_des_ede3_cfb64 := LoadFunction('EVP_des_ede3_cfb64', LFailed);
    EVP_des_ede3_cfb1 := LoadFunction('EVP_des_ede3_cfb1', LFailed);
    EVP_des_ede3_cfb8 := LoadFunction('EVP_des_ede3_cfb8', LFailed);
    EVP_des_ofb := LoadFunction('EVP_des_ofb', LFailed);
    EVP_des_ede_ofb := LoadFunction('EVP_des_ede_ofb', LFailed);
    EVP_des_ede3_ofb := LoadFunction('EVP_des_ede3_ofb', LFailed);
    EVP_des_cbc := LoadFunction('EVP_des_cbc', LFailed);
    EVP_des_ede_cbc := LoadFunction('EVP_des_ede_cbc', LFailed);
    EVP_des_ede3_cbc := LoadFunction('EVP_des_ede3_cbc', LFailed);
    EVP_desx_cbc := LoadFunction('EVP_desx_cbc', LFailed);
    EVP_des_ede3_wrap := LoadFunction('EVP_des_ede3_wrap', LFailed);
    EVP_rc4 := LoadFunction('EVP_rc4', LFailed);
    EVP_rc4_40 := LoadFunction('EVP_rc4_40', LFailed);
    EVP_idea_ecb := LoadFunction('EVP_idea_ecb', LFailed);
    EVP_idea_cfb64 := LoadFunction('EVP_idea_cfb64', LFailed);
    EVP_idea_ofb := LoadFunction('EVP_idea_ofb', LFailed);
    EVP_idea_cbc := LoadFunction('EVP_idea_cbc', LFailed);
    EVP_rc2_ecb := LoadFunction('EVP_rc2_ecb', LFailed);
    EVP_rc2_cbc := LoadFunction('EVP_rc2_cbc', LFailed);
    EVP_rc2_40_cbc := LoadFunction('EVP_rc2_40_cbc', LFailed);
    EVP_rc2_64_cbc := LoadFunction('EVP_rc2_64_cbc', LFailed);
    EVP_rc2_cfb64 := LoadFunction('EVP_rc2_cfb64', LFailed);
    EVP_rc2_ofb := LoadFunction('EVP_rc2_ofb', LFailed);
    EVP_bf_ecb := LoadFunction('EVP_bf_ecb', LFailed);
    EVP_bf_cbc := LoadFunction('EVP_bf_cbc', LFailed);
    EVP_bf_cfb64 := LoadFunction('EVP_bf_cfb64', LFailed);
    EVP_bf_ofb := LoadFunction('EVP_bf_ofb', LFailed);
    EVP_cast5_ecb := LoadFunction('EVP_cast5_ecb', LFailed);
    EVP_cast5_cbc := LoadFunction('EVP_cast5_cbc', LFailed);
    EVP_cast5_cfb64 := LoadFunction('EVP_cast5_cfb64', LFailed);
    EVP_cast5_ofb := LoadFunction('EVP_cast5_ofb', LFailed);
    EVP_rc5_32_12_16_cbc := LoadFunction('EVP_rc5_32_12_16_cbc', LFailed);
    EVP_rc5_32_12_16_ecb := LoadFunction('EVP_rc5_32_12_16_ecb', LFailed);
    EVP_rc5_32_12_16_cfb64 := LoadFunction('EVP_rc5_32_12_16_cfb64', LFailed);
    EVP_rc5_32_12_16_ofb := LoadFunction('EVP_rc5_32_12_16_ofb', LFailed);
    EVP_aes_128_ecb := LoadFunction('EVP_aes_128_ecb', LFailed);
    EVP_aes_128_cbc := LoadFunction('EVP_aes_128_cbc', LFailed);
    EVP_aes_128_cfb1 := LoadFunction('EVP_aes_128_cfb1', LFailed);
    EVP_aes_128_cfb8 := LoadFunction('EVP_aes_128_cfb8', LFailed);
    EVP_aes_128_cfb128 := LoadFunction('EVP_aes_128_cfb128', LFailed);
    EVP_aes_128_ofb := LoadFunction('EVP_aes_128_ofb', LFailed);
    EVP_aes_128_ctr := LoadFunction('EVP_aes_128_ctr', LFailed);
    EVP_aes_128_ccm := LoadFunction('EVP_aes_128_ccm', LFailed);
    EVP_aes_128_gcm := LoadFunction('EVP_aes_128_gcm', LFailed);
    EVP_aes_128_xts := LoadFunction('EVP_aes_128_xts', LFailed);
    EVP_aes_128_wrap := LoadFunction('EVP_aes_128_wrap', LFailed);
    EVP_aes_128_wrap_pad := LoadFunction('EVP_aes_128_wrap_pad', LFailed);
    EVP_aes_128_ocb := LoadFunction('EVP_aes_128_ocb', LFailed);
    EVP_aes_192_ecb := LoadFunction('EVP_aes_192_ecb', LFailed);
    EVP_aes_192_cbc := LoadFunction('EVP_aes_192_cbc', LFailed);
    EVP_aes_192_cfb1 := LoadFunction('EVP_aes_192_cfb1', LFailed);
    EVP_aes_192_cfb8 := LoadFunction('EVP_aes_192_cfb8', LFailed);
    EVP_aes_192_cfb128 := LoadFunction('EVP_aes_192_cfb128', LFailed);
    EVP_aes_192_ofb := LoadFunction('EVP_aes_192_ofb', LFailed);
    EVP_aes_192_ctr := LoadFunction('EVP_aes_192_ctr', LFailed);
    EVP_aes_192_ccm := LoadFunction('EVP_aes_192_ccm', LFailed);
    EVP_aes_192_gcm := LoadFunction('EVP_aes_192_gcm', LFailed);
    EVP_aes_192_wrap := LoadFunction('EVP_aes_192_wrap', LFailed);
    EVP_aes_192_wrap_pad := LoadFunction('EVP_aes_192_wrap_pad', LFailed);
    EVP_aes_192_ocb := LoadFunction('EVP_aes_192_ocb', LFailed);
    EVP_aes_256_ecb := LoadFunction('EVP_aes_256_ecb', LFailed);
    EVP_aes_256_cbc := LoadFunction('EVP_aes_256_cbc', LFailed);
    EVP_aes_256_cfb1 := LoadFunction('EVP_aes_256_cfb1', LFailed);
    EVP_aes_256_cfb8 := LoadFunction('EVP_aes_256_cfb8', LFailed);
    EVP_aes_256_cfb128 := LoadFunction('EVP_aes_256_cfb128', LFailed);
    EVP_aes_256_ofb := LoadFunction('EVP_aes_256_ofb', LFailed);
    EVP_aes_256_ctr := LoadFunction('EVP_aes_256_ctr', LFailed);
    EVP_aes_256_ccm := LoadFunction('EVP_aes_256_ccm', LFailed);
    EVP_aes_256_gcm := LoadFunction('EVP_aes_256_gcm', LFailed);
    EVP_aes_256_xts := LoadFunction('EVP_aes_256_xts', LFailed);
    EVP_aes_256_wrap := LoadFunction('EVP_aes_256_wrap', LFailed);
    EVP_aes_256_wrap_pad := LoadFunction('EVP_aes_256_wrap_pad', LFailed);
    EVP_aes_256_ocb := LoadFunction('EVP_aes_256_ocb', LFailed);
    EVP_aes_128_cbc_hmac_sha1 := LoadFunction('EVP_aes_128_cbc_hmac_sha1', LFailed);
    EVP_aes_256_cbc_hmac_sha1 := LoadFunction('EVP_aes_256_cbc_hmac_sha1', LFailed);
    EVP_aes_128_cbc_hmac_sha256 := LoadFunction('EVP_aes_128_cbc_hmac_sha256', LFailed);
    EVP_aes_256_cbc_hmac_sha256 := LoadFunction('EVP_aes_256_cbc_hmac_sha256', LFailed);
    EVP_aria_128_ecb := LoadFunction('EVP_aria_128_ecb', LFailed);
    EVP_aria_128_cbc := LoadFunction('EVP_aria_128_cbc', LFailed);
    EVP_aria_128_cfb1 := LoadFunction('EVP_aria_128_cfb1', LFailed);
    EVP_aria_128_cfb8 := LoadFunction('EVP_aria_128_cfb8', LFailed);
    EVP_aria_128_cfb128 := LoadFunction('EVP_aria_128_cfb128', LFailed);
    EVP_aria_128_ctr := LoadFunction('EVP_aria_128_ctr', LFailed);
    EVP_aria_128_ofb := LoadFunction('EVP_aria_128_ofb', LFailed);
    EVP_aria_128_gcm := LoadFunction('EVP_aria_128_gcm', LFailed);
    EVP_aria_128_ccm := LoadFunction('EVP_aria_128_ccm', LFailed);
    EVP_aria_192_ecb := LoadFunction('EVP_aria_192_ecb', LFailed);
    EVP_aria_192_cbc := LoadFunction('EVP_aria_192_cbc', LFailed);
    EVP_aria_192_cfb1 := LoadFunction('EVP_aria_192_cfb1', LFailed);
    EVP_aria_192_cfb8 := LoadFunction('EVP_aria_192_cfb8', LFailed);
    EVP_aria_192_cfb128 := LoadFunction('EVP_aria_192_cfb128', LFailed);
    EVP_aria_192_ctr := LoadFunction('EVP_aria_192_ctr', LFailed);
    EVP_aria_192_ofb := LoadFunction('EVP_aria_192_ofb', LFailed);
    EVP_aria_192_gcm := LoadFunction('EVP_aria_192_gcm', LFailed);
    EVP_aria_192_ccm := LoadFunction('EVP_aria_192_ccm', LFailed);
    EVP_aria_256_ecb := LoadFunction('EVP_aria_256_ecb', LFailed);
    EVP_aria_256_cbc := LoadFunction('EVP_aria_256_cbc', LFailed);
    EVP_aria_256_cfb1 := LoadFunction('EVP_aria_256_cfb1', LFailed);
    EVP_aria_256_cfb8 := LoadFunction('EVP_aria_256_cfb8', LFailed);
    EVP_aria_256_cfb128 := LoadFunction('EVP_aria_256_cfb128', LFailed);
    EVP_aria_256_ctr := LoadFunction('EVP_aria_256_ctr', LFailed);
    EVP_aria_256_ofb := LoadFunction('EVP_aria_256_ofb', LFailed);
    EVP_aria_256_gcm := LoadFunction('EVP_aria_256_gcm', LFailed);
    EVP_aria_256_ccm := LoadFunction('EVP_aria_256_ccm', LFailed);
    EVP_camellia_128_ecb := LoadFunction('EVP_camellia_128_ecb', LFailed);
    EVP_camellia_128_cbc := LoadFunction('EVP_camellia_128_cbc', LFailed);
    EVP_camellia_128_cfb1 := LoadFunction('EVP_camellia_128_cfb1', LFailed);
    EVP_camellia_128_cfb8 := LoadFunction('EVP_camellia_128_cfb8', LFailed);
    EVP_camellia_128_cfb128 := LoadFunction('EVP_camellia_128_cfb128', LFailed);
    EVP_camellia_128_ofb := LoadFunction('EVP_camellia_128_ofb', LFailed);
    EVP_camellia_128_ctr := LoadFunction('EVP_camellia_128_ctr', LFailed);
    EVP_camellia_192_ecb := LoadFunction('EVP_camellia_192_ecb', LFailed);
    EVP_camellia_192_cbc := LoadFunction('EVP_camellia_192_cbc', LFailed);
    EVP_camellia_192_cfb1 := LoadFunction('EVP_camellia_192_cfb1', LFailed);
    EVP_camellia_192_cfb8 := LoadFunction('EVP_camellia_192_cfb8', LFailed);
    EVP_camellia_192_cfb128 := LoadFunction('EVP_camellia_192_cfb128', LFailed);
    EVP_camellia_192_ofb := LoadFunction('EVP_camellia_192_ofb', LFailed);
    EVP_camellia_192_ctr := LoadFunction('EVP_camellia_192_ctr', LFailed);
    EVP_camellia_256_ecb := LoadFunction('EVP_camellia_256_ecb', LFailed);
    EVP_camellia_256_cbc := LoadFunction('EVP_camellia_256_cbc', LFailed);
    EVP_camellia_256_cfb1 := LoadFunction('EVP_camellia_256_cfb1', LFailed);
    EVP_camellia_256_cfb8 := LoadFunction('EVP_camellia_256_cfb8', LFailed);
    EVP_camellia_256_cfb128 := LoadFunction('EVP_camellia_256_cfb128', LFailed);
    EVP_camellia_256_ofb := LoadFunction('EVP_camellia_256_ofb', LFailed);
    EVP_camellia_256_ctr := LoadFunction('EVP_camellia_256_ctr', LFailed);
    EVP_chacha20 := LoadFunction('EVP_chacha20', LFailed);
    EVP_chacha20_poly1305 := LoadFunction('EVP_chacha20_poly1305', LFailed);
    EVP_seed_ecb := LoadFunction('EVP_seed_ecb', LFailed);
    EVP_seed_cbc := LoadFunction('EVP_seed_cbc', LFailed);
    EVP_seed_cfb128 := LoadFunction('EVP_seed_cfb128', LFailed);
    EVP_seed_ofb := LoadFunction('EVP_seed_ofb', LFailed);
    EVP_sm4_ecb := LoadFunction('EVP_sm4_ecb', LFailed);
    EVP_sm4_cbc := LoadFunction('EVP_sm4_cbc', LFailed);
    EVP_sm4_cfb128 := LoadFunction('EVP_sm4_cfb128', LFailed);
    EVP_sm4_ofb := LoadFunction('EVP_sm4_ofb', LFailed);
    EVP_sm4_ctr := LoadFunction('EVP_sm4_ctr', LFailed);
    EVP_add_cipher := LoadFunction('EVP_add_cipher', LFailed);
    EVP_add_digest := LoadFunction('EVP_add_digest', LFailed);
    EVP_get_cipherbyname := LoadFunction('EVP_get_cipherbyname', LFailed);
    EVP_get_digestbyname := LoadFunction('EVP_get_digestbyname', LFailed);
    EVP_CIPHER_do_all := LoadFunction('EVP_CIPHER_do_all', LFailed);
    EVP_CIPHER_do_all_sorted := LoadFunction('EVP_CIPHER_do_all_sorted', LFailed);
    EVP_MD_do_all := LoadFunction('EVP_MD_do_all', LFailed);
    EVP_MD_do_all_sorted := LoadFunction('EVP_MD_do_all_sorted', LFailed);
    EVP_PKEY_decrypt_old := LoadFunction('EVP_PKEY_decrypt_old', LFailed);
    EVP_PKEY_encrypt_old := LoadFunction('EVP_PKEY_encrypt_old', LFailed);
    EVP_PKEY_type := LoadFunction('EVP_PKEY_type', LFailed);
    EVP_PKEY_id := LoadFunction('EVP_PKEY_id', LFailed);
    EVP_PKEY_base_id := LoadFunction('EVP_PKEY_base_id', LFailed);
    EVP_PKEY_bits := LoadFunction('EVP_PKEY_bits', LFailed);
    EVP_PKEY_security_bits := LoadFunction('EVP_PKEY_security_bits', LFailed);
    EVP_PKEY_size := LoadFunction('EVP_PKEY_size', LFailed);
    EVP_PKEY_set_type := LoadFunction('EVP_PKEY_set_type', LFailed);
    EVP_PKEY_set_type_str := LoadFunction('EVP_PKEY_set_type_str', LFailed);
    EVP_PKEY_set_alias_type := LoadFunction('EVP_PKEY_set_alias_type', LFailed);
    EVP_PKEY_set1_engine := LoadFunction('EVP_PKEY_set1_engine', LFailed);
    EVP_PKEY_get0_engine := LoadFunction('EVP_PKEY_get0_engine', LFailed);
    EVP_PKEY_assign := LoadFunction('EVP_PKEY_assign', LFailed);
    EVP_PKEY_get0 := LoadFunction('EVP_PKEY_get0', LFailed);
    EVP_PKEY_get0_hmac := LoadFunction('EVP_PKEY_get0_hmac', LFailed);
    EVP_PKEY_get0_poly1305 := LoadFunction('EVP_PKEY_get0_poly1305', LFailed);
    EVP_PKEY_get0_siphash := LoadFunction('EVP_PKEY_get0_siphash', LFailed);
    EVP_PKEY_set1_RSA := LoadFunction('EVP_PKEY_set1_RSA', LFailed);
    EVP_PKEY_get0_RSA := LoadFunction('EVP_PKEY_get0_RSA', LFailed);
    EVP_PKEY_get1_RSA := LoadFunction('EVP_PKEY_get1_RSA', LFailed);
    EVP_PKEY_set1_DSA := LoadFunction('EVP_PKEY_set1_DSA', LFailed);
    EVP_PKEY_get0_DSA := LoadFunction('EVP_PKEY_get0_DSA', LFailed);
    EVP_PKEY_get1_DSA := LoadFunction('EVP_PKEY_get1_DSA', LFailed);
    EVP_PKEY_set1_DH := LoadFunction('EVP_PKEY_set1_DH', LFailed);
    EVP_PKEY_get0_DH := LoadFunction('EVP_PKEY_get0_DH', LFailed);
    EVP_PKEY_get1_DH := LoadFunction('EVP_PKEY_get1_DH', LFailed);
    EVP_PKEY_set1_EC_KEY := LoadFunction('EVP_PKEY_set1_EC_KEY', LFailed);
    EVP_PKEY_get0_EC_KEY := LoadFunction('EVP_PKEY_get0_EC_KEY', LFailed);
    EVP_PKEY_get1_EC_KEY := LoadFunction('EVP_PKEY_get1_EC_KEY', LFailed);
    EVP_PKEY_new := LoadFunction('EVP_PKEY_new', LFailed);
    EVP_PKEY_up_ref := LoadFunction('EVP_PKEY_up_ref', LFailed);
    EVP_PKEY_free := LoadFunction('EVP_PKEY_free', LFailed);
    d2i_PublicKey := LoadFunction('d2i_PublicKey', LFailed);
    i2d_PublicKey := LoadFunction('i2d_PublicKey', LFailed);
    d2i_PrivateKey := LoadFunction('d2i_PrivateKey', LFailed);
    d2i_AutoPrivateKey := LoadFunction('d2i_AutoPrivateKey', LFailed);
    i2d_PrivateKey := LoadFunction('i2d_PrivateKey', LFailed);
    EVP_PKEY_copy_parameters := LoadFunction('EVP_PKEY_copy_parameters', LFailed);
    EVP_PKEY_missing_parameters := LoadFunction('EVP_PKEY_missing_parameters', LFailed);
    EVP_PKEY_save_parameters := LoadFunction('EVP_PKEY_save_parameters', LFailed);
    EVP_PKEY_cmp_parameters := LoadFunction('EVP_PKEY_cmp_parameters', LFailed);
    EVP_PKEY_cmp := LoadFunction('EVP_PKEY_cmp', LFailed);
    EVP_PKEY_print_public := LoadFunction('EVP_PKEY_print_public', LFailed);
    EVP_PKEY_print_private := LoadFunction('EVP_PKEY_print_private', LFailed);
    EVP_PKEY_print_params := LoadFunction('EVP_PKEY_print_params', LFailed);
    EVP_PKEY_get_default_digest_nid := LoadFunction('EVP_PKEY_get_default_digest_nid', LFailed);
    EVP_PKEY_set1_tls_encodedpoint := LoadFunction('EVP_PKEY_set1_tls_encodedpoint', LFailed);
    EVP_PKEY_get1_tls_encodedpoint := LoadFunction('EVP_PKEY_get1_tls_encodedpoint', LFailed);
    EVP_CIPHER_type := LoadFunction('EVP_CIPHER_type', LFailed);
    EVP_CIPHER_param_to_asn1 := LoadFunction('EVP_CIPHER_param_to_asn1', LFailed);
    EVP_CIPHER_asn1_to_param := LoadFunction('EVP_CIPHER_asn1_to_param', LFailed);
    EVP_CIPHER_set_asn1_iv := LoadFunction('EVP_CIPHER_set_asn1_iv', LFailed);
    EVP_CIPHER_get_asn1_iv := LoadFunction('EVP_CIPHER_get_asn1_iv', LFailed);
    PKCS5_PBE_keyivgen := LoadFunction('PKCS5_PBE_keyivgen', LFailed);
    PKCS5_PBKDF2_HMAC_SHA1 := LoadFunction('PKCS5_PBKDF2_HMAC_SHA1', LFailed);
    PKCS5_PBKDF2_HMAC := LoadFunction('PKCS5_PBKDF2_HMAC', LFailed);
    PKCS5_v2_PBE_keyivgen := LoadFunction('PKCS5_v2_PBE_keyivgen', LFailed);
    EVP_PBE_scrypt := LoadFunction('EVP_PBE_scrypt', LFailed);
    PKCS5_v2_scrypt_keyivgen := LoadFunction('PKCS5_v2_scrypt_keyivgen', LFailed);
    PKCS5_PBE_add := LoadFunction('PKCS5_PBE_add', LFailed);
    EVP_PBE_CipherInit := LoadFunction('EVP_PBE_CipherInit', LFailed);
    EVP_PBE_alg_add_type := LoadFunction('EVP_PBE_alg_add_type', LFailed);
    EVP_PBE_alg_add := LoadFunction('EVP_PBE_alg_add', LFailed);
    EVP_PBE_find := LoadFunction('EVP_PBE_find', LFailed);
    EVP_PBE_cleanup := LoadFunction('EVP_PBE_cleanup', LFailed);
    EVP_PBE_get := LoadFunction('EVP_PBE_get', LFailed);
    EVP_PKEY_asn1_get_count := LoadFunction('EVP_PKEY_asn1_get_count', LFailed);
    EVP_PKEY_asn1_get0 := LoadFunction('EVP_PKEY_asn1_get0', LFailed);
    EVP_PKEY_asn1_find := LoadFunction('EVP_PKEY_asn1_find', LFailed);
    EVP_PKEY_asn1_find_str := LoadFunction('EVP_PKEY_asn1_find_str', LFailed);
    EVP_PKEY_asn1_add0 := LoadFunction('EVP_PKEY_asn1_add0', LFailed);
    EVP_PKEY_asn1_add_alias := LoadFunction('EVP_PKEY_asn1_add_alias', LFailed);
    EVP_PKEY_asn1_get0_info := LoadFunction('EVP_PKEY_asn1_get0_info', LFailed);
    EVP_PKEY_get0_asn1 := LoadFunction('EVP_PKEY_get0_asn1', LFailed);
    EVP_PKEY_asn1_new := LoadFunction('EVP_PKEY_asn1_new', LFailed);
    EVP_PKEY_asn1_copy := LoadFunction('EVP_PKEY_asn1_copy', LFailed);
    EVP_PKEY_asn1_free := LoadFunction('EVP_PKEY_asn1_free', LFailed);
    EVP_PKEY_asn1_set_public := LoadFunction('EVP_PKEY_asn1_set_public', LFailed);
    EVP_PKEY_asn1_set_private := LoadFunction('EVP_PKEY_asn1_set_private', LFailed);
    EVP_PKEY_asn1_set_param := LoadFunction('EVP_PKEY_asn1_set_param', LFailed);
    EVP_PKEY_asn1_set_free := LoadFunction('EVP_PKEY_asn1_set_free', LFailed);
    EVP_PKEY_asn1_set_ctrl := LoadFunction('EVP_PKEY_asn1_set_ctrl', LFailed);
    EVP_PKEY_asn1_set_item := LoadFunction('EVP_PKEY_asn1_set_item', LFailed);
    EVP_PKEY_asn1_set_siginf := LoadFunction('EVP_PKEY_asn1_set_siginf', LFailed);
    EVP_PKEY_asn1_set_check := LoadFunction('EVP_PKEY_asn1_set_check', LFailed);
    EVP_PKEY_asn1_set_public_check := LoadFunction('EVP_PKEY_asn1_set_public_check', LFailed);
    EVP_PKEY_asn1_set_param_check := LoadFunction('EVP_PKEY_asn1_set_param_check', LFailed);
    EVP_PKEY_asn1_set_set_priv_key := LoadFunction('EVP_PKEY_asn1_set_set_priv_key', LFailed);
    EVP_PKEY_asn1_set_set_pub_key := LoadFunction('EVP_PKEY_asn1_set_set_pub_key', LFailed);
    EVP_PKEY_asn1_set_get_priv_key := LoadFunction('EVP_PKEY_asn1_set_get_priv_key', LFailed);
    EVP_PKEY_asn1_set_get_pub_key := LoadFunction('EVP_PKEY_asn1_set_get_pub_key', LFailed);
    EVP_PKEY_asn1_set_security_bits := LoadFunction('EVP_PKEY_asn1_set_security_bits', LFailed);
    EVP_PKEY_meth_find := LoadFunction('EVP_PKEY_meth_find', LFailed);
    EVP_PKEY_meth_new := LoadFunction('EVP_PKEY_meth_new', LFailed);
    EVP_PKEY_meth_get0_info := LoadFunction('EVP_PKEY_meth_get0_info', LFailed);
    EVP_PKEY_meth_copy := LoadFunction('EVP_PKEY_meth_copy', LFailed);
    EVP_PKEY_meth_free := LoadFunction('EVP_PKEY_meth_free', LFailed);
    EVP_PKEY_meth_add0 := LoadFunction('EVP_PKEY_meth_add0', LFailed);
    EVP_PKEY_meth_remove := LoadFunction('EVP_PKEY_meth_remove', LFailed);
    EVP_PKEY_meth_get_count := LoadFunction('EVP_PKEY_meth_get_count', LFailed);
    EVP_PKEY_meth_get0 := LoadFunction('EVP_PKEY_meth_get0', LFailed);
    EVP_PKEY_CTX_new := LoadFunction('EVP_PKEY_CTX_new', LFailed);
    EVP_PKEY_CTX_new_id := LoadFunction('EVP_PKEY_CTX_new_id', LFailed);
    EVP_PKEY_CTX_dup := LoadFunction('EVP_PKEY_CTX_dup', LFailed);
    EVP_PKEY_CTX_free := LoadFunction('EVP_PKEY_CTX_free', LFailed);
    EVP_PKEY_CTX_ctrl := LoadFunction('EVP_PKEY_CTX_ctrl', LFailed);
    EVP_PKEY_CTX_ctrl_str := LoadFunction('EVP_PKEY_CTX_ctrl_str', LFailed);
    EVP_PKEY_CTX_ctrl_uint64 := LoadFunction('EVP_PKEY_CTX_ctrl_uint64', LFailed);
    EVP_PKEY_CTX_str2ctrl := LoadFunction('EVP_PKEY_CTX_str2ctrl', LFailed);
    EVP_PKEY_CTX_hex2ctrl := LoadFunction('EVP_PKEY_CTX_hex2ctrl', LFailed);
    EVP_PKEY_CTX_md := LoadFunction('EVP_PKEY_CTX_md', LFailed);
    EVP_PKEY_CTX_get_operation := LoadFunction('EVP_PKEY_CTX_get_operation', LFailed);
    EVP_PKEY_CTX_set0_keygen_info := LoadFunction('EVP_PKEY_CTX_set0_keygen_info', LFailed);
    EVP_PKEY_new_mac_key := LoadFunction('EVP_PKEY_new_mac_key', LFailed);
    EVP_PKEY_new_raw_private_key := LoadFunction('EVP_PKEY_new_raw_private_key', LFailed);
    EVP_PKEY_new_raw_public_key := LoadFunction('EVP_PKEY_new_raw_public_key', LFailed);
    EVP_PKEY_get_raw_private_key := LoadFunction('EVP_PKEY_get_raw_private_key', LFailed);
    EVP_PKEY_get_raw_public_key := LoadFunction('EVP_PKEY_get_raw_public_key', LFailed);
    EVP_PKEY_new_CMAC_key := LoadFunction('EVP_PKEY_new_CMAC_key', LFailed);
    EVP_PKEY_CTX_set_data := LoadFunction('EVP_PKEY_CTX_set_data', LFailed);
    EVP_PKEY_CTX_get_data := LoadFunction('EVP_PKEY_CTX_get_data', LFailed);
    EVP_PKEY_CTX_get0_pkey := LoadFunction('EVP_PKEY_CTX_get0_pkey', LFailed);
    EVP_PKEY_CTX_get0_peerkey := LoadFunction('EVP_PKEY_CTX_get0_peerkey', LFailed);
    EVP_PKEY_CTX_set_app_data := LoadFunction('EVP_PKEY_CTX_set_app_data', LFailed);
    EVP_PKEY_CTX_get_app_data := LoadFunction('EVP_PKEY_CTX_get_app_data', LFailed);
    EVP_PKEY_sign_init := LoadFunction('EVP_PKEY_sign_init', LFailed);
    EVP_PKEY_sign := LoadFunction('EVP_PKEY_sign', LFailed);
    EVP_PKEY_verify_init := LoadFunction('EVP_PKEY_verify_init', LFailed);
    EVP_PKEY_verify := LoadFunction('EVP_PKEY_verify', LFailed);
    EVP_PKEY_verify_recover_init := LoadFunction('EVP_PKEY_verify_recover_init', LFailed);
    EVP_PKEY_verify_recover := LoadFunction('EVP_PKEY_verify_recover', LFailed);
    EVP_PKEY_encrypt_init := LoadFunction('EVP_PKEY_encrypt_init', LFailed);
    EVP_PKEY_encrypt := LoadFunction('EVP_PKEY_encrypt', LFailed);
    EVP_PKEY_decrypt_init := LoadFunction('EVP_PKEY_decrypt_init', LFailed);
    EVP_PKEY_decrypt := LoadFunction('EVP_PKEY_decrypt', LFailed);
    EVP_PKEY_derive_init := LoadFunction('EVP_PKEY_derive_init', LFailed);
    EVP_PKEY_derive_set_peer := LoadFunction('EVP_PKEY_derive_set_peer', LFailed);
    EVP_PKEY_derive := LoadFunction('EVP_PKEY_derive', LFailed);
    EVP_PKEY_paramgen_init := LoadFunction('EVP_PKEY_paramgen_init', LFailed);
    EVP_PKEY_paramgen := LoadFunction('EVP_PKEY_paramgen', LFailed);
    EVP_PKEY_keygen_init := LoadFunction('EVP_PKEY_keygen_init', LFailed);
    EVP_PKEY_keygen := LoadFunction('EVP_PKEY_keygen', LFailed);
    EVP_PKEY_check := LoadFunction('EVP_PKEY_check', LFailed);
    EVP_PKEY_public_check := LoadFunction('EVP_PKEY_public_check', LFailed);
    EVP_PKEY_param_check := LoadFunction('EVP_PKEY_param_check', LFailed);
    EVP_PKEY_CTX_set_cb := LoadFunction('EVP_PKEY_CTX_set_cb', LFailed);
    EVP_PKEY_CTX_get_cb := LoadFunction('EVP_PKEY_CTX_get_cb', LFailed);
    EVP_PKEY_CTX_get_keygen_info := LoadFunction('EVP_PKEY_CTX_get_keygen_info', LFailed);
    EVP_PKEY_meth_set_init := LoadFunction('EVP_PKEY_meth_set_init', LFailed);
    EVP_PKEY_meth_set_copy := LoadFunction('EVP_PKEY_meth_set_copy', LFailed);
    EVP_PKEY_meth_set_cleanup := LoadFunction('EVP_PKEY_meth_set_cleanup', LFailed);
    EVP_PKEY_meth_set_paramgen := LoadFunction('EVP_PKEY_meth_set_paramgen', LFailed);
    EVP_PKEY_meth_set_keygen := LoadFunction('EVP_PKEY_meth_set_keygen', LFailed);
    EVP_PKEY_meth_set_sign := LoadFunction('EVP_PKEY_meth_set_sign', LFailed);
    EVP_PKEY_meth_set_verify := LoadFunction('EVP_PKEY_meth_set_verify', LFailed);
    EVP_PKEY_meth_set_verify_recover := LoadFunction('EVP_PKEY_meth_set_verify_recover', LFailed);
    EVP_PKEY_meth_set_signctx := LoadFunction('EVP_PKEY_meth_set_signctx', LFailed);
    EVP_PKEY_meth_set_verifyctx := LoadFunction('EVP_PKEY_meth_set_verifyctx', LFailed);
    EVP_PKEY_meth_set_encrypt := LoadFunction('EVP_PKEY_meth_set_encrypt', LFailed);
    EVP_PKEY_meth_set_decrypt := LoadFunction('EVP_PKEY_meth_set_decrypt', LFailed);
    EVP_PKEY_meth_set_derive := LoadFunction('EVP_PKEY_meth_set_derive', LFailed);
    EVP_PKEY_meth_set_ctrl := LoadFunction('EVP_PKEY_meth_set_ctrl', LFailed);
    EVP_PKEY_meth_set_digestsign := LoadFunction('EVP_PKEY_meth_set_digestsign', LFailed);
    EVP_PKEY_meth_set_digestverify := LoadFunction('EVP_PKEY_meth_set_digestverify', LFailed);
    EVP_PKEY_meth_set_check := LoadFunction('EVP_PKEY_meth_set_check', LFailed);
    EVP_PKEY_meth_set_public_check := LoadFunction('EVP_PKEY_meth_set_public_check', LFailed);
    EVP_PKEY_meth_set_param_check := LoadFunction('EVP_PKEY_meth_set_param_check', LFailed);
    EVP_PKEY_meth_set_digest_custom := LoadFunction('EVP_PKEY_meth_set_digest_custom', LFailed);
    EVP_PKEY_meth_get_init := LoadFunction('EVP_PKEY_meth_get_init', LFailed);
    EVP_PKEY_meth_get_copy := LoadFunction('EVP_PKEY_meth_get_copy', LFailed);
    EVP_PKEY_meth_get_cleanup := LoadFunction('EVP_PKEY_meth_get_cleanup', LFailed);
    EVP_PKEY_meth_get_paramgen := LoadFunction('EVP_PKEY_meth_get_paramgen', LFailed);
    EVP_PKEY_meth_get_keygen := LoadFunction('EVP_PKEY_meth_get_keygen', LFailed);
    EVP_PKEY_meth_get_sign := LoadFunction('EVP_PKEY_meth_get_sign', LFailed);
    EVP_PKEY_meth_get_verify := LoadFunction('EVP_PKEY_meth_get_verify', LFailed);
    EVP_PKEY_meth_get_verify_recover := LoadFunction('EVP_PKEY_meth_get_verify_recover', LFailed);
    EVP_PKEY_meth_get_signctx := LoadFunction('EVP_PKEY_meth_get_signctx', LFailed);
    EVP_PKEY_meth_get_verifyctx := LoadFunction('EVP_PKEY_meth_get_verifyctx', LFailed);
    EVP_PKEY_meth_get_encrypt := LoadFunction('EVP_PKEY_meth_get_encrypt', LFailed);
    EVP_PKEY_meth_get_decrypt := LoadFunction('EVP_PKEY_meth_get_decrypt', LFailed);
    EVP_PKEY_meth_get_derive := LoadFunction('EVP_PKEY_meth_get_derive', LFailed);
    EVP_PKEY_meth_get_ctrl := LoadFunction('EVP_PKEY_meth_get_ctrl', LFailed);
    EVP_PKEY_meth_get_digestsign := LoadFunction('EVP_PKEY_meth_get_digestsign', LFailed);
    EVP_PKEY_meth_get_digestverify := LoadFunction('EVP_PKEY_meth_get_digestverify', LFailed);
    EVP_PKEY_meth_get_check := LoadFunction('EVP_PKEY_meth_get_check', LFailed);
    EVP_PKEY_meth_get_public_check := LoadFunction('EVP_PKEY_meth_get_public_check', LFailed);
    EVP_PKEY_meth_get_param_check := LoadFunction('EVP_PKEY_meth_get_param_check', LFailed);
    EVP_PKEY_meth_get_digest_custom := LoadFunction('EVP_PKEY_meth_get_digest_custom', LFailed);
    EVP_add_alg_module := LoadFunction('EVP_add_alg_module', LFailed);

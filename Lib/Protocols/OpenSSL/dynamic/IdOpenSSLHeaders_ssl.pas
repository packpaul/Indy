...
var
   ...
   *)
  SSL_get_finished: function(const s: PSSL; buf: Pointer; count: Size_t): Size_t cdecl = nil;
  SSL_get_peer_finished: function(const s: PSSL; buf: Pointer; count: Size_t): Size_t cdecl = nil;
  ...
  SSL_CTX_use_serverinfo: function(ctx: PSSL_CTX; const serverinfo: PByte; serverinfo_length: size_t): TIdC_INT cdecl = nil;
  SSL_CTX_use_serverinfo_ex: function(ctx: PSSL_CTX; version: TIdC_UINT; const serverinfo: PByte; serverinfo_length: size_t): TIdC_INT cdecl = nil;
  ...
  SSL_SESSION_get0_alpn_selected: procedure(const s: PSSL_SESSION; const alpn: PPByte; len: PSize_t) cdecl = nil;
  SSL_SESSION_set1_alpn_selected: function(s: PSSL_SESSION; const alpn: PByte; len: size_t): TIdC_INT cdecl = nil;
  ...
  SSL_SESSION_get0_ticket: procedure(const s: PSSL_SESSION; const tick: PPByte; len: PSize_t) cdecl = nil;
  ...
  SSL_dane_tlsa_add: function(s: PSSL; usage: TIdC_UINT8; selector: TIdC_UINT8; mtype: TIdC_UINT8; const data: PByte; dlen: size_t): TIdC_INT cdecl = nil;
  SSL_get0_dane_authority: function(s: PSSL; mcert: PPX509; mspki: PPEVP_PKEY): TIdC_INT cdecl = nil;
  SSL_get0_dane_tlsa: function(s: PSSL; usage: PIdC_UINT8; selector: PIdC_UINT8; mtype: PIdC_UINT8; const data: PPByte; dlen: Psize_t): TIdC_INT cdecl = nil;
  (*
  ...
  SSL_client_hello_get0_random: function(s: PSSL; const &out: PPByte): Size_t cdecl = nil;
  SSL_client_hello_get0_session_id: function(s: PSSL; const &out: PPByte): Size_t cdecl = nil;
  SSL_client_hello_get0_ciphers: function(s: PSSL; const &out: PPByte): Size_t cdecl = nil;
  SSL_client_hello_get0_compression_methods: function(s: PSSL; const &out: PPByte): Size_t cdecl = nil;
  SSL_client_hello_get1_extensions_present: function(s: PSSL; &out: PPIdC_INT; outlen: PSize_t): TIdC_INT cdecl = nil;
  SSL_client_hello_get0_ext: function(s: PSSL; &type: TIdC_UINT; const &out: PPByte; outlen: PSize_t): TIdC_INT cdecl = nil;
  ...
  SSL_get_all_async_fds: function(s: PSSL; fds: POSSL_ASYNC_FD; numfds: Psize_t): TIdC_INT cdecl = nil;
  SSL_get_changed_async_fds: function(s: PSSL; addfd: POSSL_ASYNC_FD; numaddfds: Psize_t; delfd: POSSL_ASYNC_FD; numdelfds: Psize_t): TIdC_INT cdecl = nil;
  ...
  SSL_read_ex: function(ssl: PSSL; buf: Pointer; num: size_t; readbytes: Psize_t): TIdC_INT cdecl = nil;

  SSL_read_early_data: function(s: PSSL; buf: Pointer; num: size_t; readbytes: Psize_t): TIdC_INT cdecl = nil;
  SSL_peek: function(ssl: PSSL; buf: Pointer; num: TIdC_INT): TIdC_INT cdecl = nil;
  SSL_peek_ex: function(ssl: PSSL; buf: Pointer; num: size_t; readbytes: Psize_t): TIdC_INT cdecl = nil;
  SSL_write: function(ssl: PSSL; const buf: Pointer; num: TIdC_INT): TIdC_INT cdecl = nil;
  SSL_write_ex: function(s: PSSL; const buf: Pointer; num: size_t; written: Psize_t): TIdC_INT cdecl = nil;
  SSL_write_early_data: function(s: PSSL; const buf: Pointer; num: size_t; written: Psize_t): TIdC_INT cdecl = nil;
  ...
  SSL_get_client_random: function(const ssl: PSSL; &out: PByte; outlen: size_t): size_t cdecl = nil;
  SSL_get_server_random: function(const ssl: PSSL; &out: PByte; outlen: size_t): size_t cdecl = nil;
  SSL_SESSION_get_master_key: function(const sess: PSSL_SESSION; &out: PByte; outlen: size_t): size_t cdecl = nil;
  SSL_SESSION_set1_master_key: function(sess: PSSL_SESSION; const &in: PByte; len: size_t): TIdC_INT cdecl = nil;
  ...
  SSL_CTX_set_default_read_buffer_len: procedure(ctx: PSSL_CTX; len: Size_t) cdecl = nil;
  SSL_set_default_read_buffer_len: procedure(s: PSSL; len: Size_t) cdecl = nil;
  ...
  SSL_CTX_set_block_padding: function(ctx: PSSL_CTX; block_size: Size_t): TIdC_INT cdecl = nil;
  ...
  SSL_set_block_padding: function(ssl: PSSL; block_size: Size_t): TIdC_INT cdecl = nil;
  SSL_set_num_tickets: function(s: PSSL; num_tickets: Size_t): TIdC_INT cdecl = nil;
  SSL_get_num_tickets: function(const s: PSSL): Size_t cdecl = nil;
  SSL_CTX_set_num_tickets: function(ctx: PSSL_CTX; num_tickets: Size_t): TIdC_INT cdecl = nil;
  SSL_CTX_get_num_tickets: function(const ctx: PSSL_CTX): Size_t cdecl = nil;
  ...
  SSL_trace: procedure(write_p: TIdC_INT; version: TIdC_INT; content_type: TIdC_INT; const buf: Pointer; len: Size_t; ssl: PSSL; arg: Pointer) cdecl = nil;
  ...
  SSL_SESSION_set1_ticket_appdata: function(ss: PSSL_SESSION; const data: Pointer; len: Size_t): TIdC_INT cdecl = nil;
  SSL_SESSION_get0_ticket_appdata: function(ss: PSSL_SESSION; data: PPointer; len: PSize_t): TIdC_INT cdecl = nil;
...
begin
  ...
  try
    SSL_CTX_get_options := LoadFunction('SSL_CTX_get_options', LFailed);
    SSL_get_options := LoadFunction('SSL_get_options', LFailed);
    SSL_CTX_clear_options := LoadFunction('SSL_CTX_clear_options', LFailed);
    SSL_clear_options := LoadFunction('SSL_clear_options', LFailed);
    SSL_CTX_set_options := LoadFunction('SSL_CTX_set_options', LFailed);
    SSL_set_options := LoadFunction('SSL_set_options', LFailed);
    SSL_CTX_sess_set_new_cb := LoadFunction('SSL_CTX_sess_set_new_cb', LFailed);
    SSL_CTX_sess_get_new_cb := LoadFunction('SSL_CTX_sess_get_new_cb', LFailed);
    SSL_CTX_sess_set_remove_cb := LoadFunction('SSL_CTX_sess_set_remove_cb', LFailed);
    SSL_CTX_sess_get_remove_cb := LoadFunction('SSL_CTX_sess_get_remove_cb', LFailed);
    SSL_CTX_set_info_callback := LoadFunction('SSL_CTX_set_info_callback', LFailed);
    SSL_CTX_get_info_callback := LoadFunction('SSL_CTX_get_info_callback', LFailed);
    SSL_CTX_set_client_cert_cb := LoadFunction('SSL_CTX_set_client_cert_cb', LFailed);
    SSL_CTX_get_client_cert_cb := LoadFunction('SSL_CTX_get_client_cert_cb', LFailed);
    SSL_CTX_set_client_cert_engine := LoadFunction('SSL_CTX_set_client_cert_engine', LFailed);
    SSL_CTX_set_cookie_generate_cb := LoadFunction('SSL_CTX_set_cookie_generate_cb', LFailed);
    SSL_CTX_set_cookie_verify_cb := LoadFunction('SSL_CTX_set_cookie_verify_cb', LFailed);
    SSL_CTX_set_stateless_cookie_generate_cb := LoadFunction('SSL_CTX_set_stateless_cookie_generate_cb', LFailed);
    SSL_CTX_set_stateless_cookie_verify_cb := LoadFunction('SSL_CTX_set_stateless_cookie_verify_cb', LFailed);
    SSL_CTX_set_alpn_select_cb := LoadFunction('SSL_CTX_set_alpn_select_cb', LFailed);
    SSL_get0_alpn_selected := LoadFunction('SSL_get0_alpn_selected', LFailed);
    SSL_CTX_set_psk_client_callback := LoadFunction('SSL_CTX_set_psk_client_callback', LFailed);
    SSL_set_psk_client_callback := LoadFunction('SSL_set_psk_client_callback', LFailed);
    SSL_CTX_set_psk_server_callback := LoadFunction('SSL_CTX_set_psk_server_callback', LFailed);
    SSL_set_psk_server_callback := LoadFunction('SSL_set_psk_server_callback', LFailed);
    SSL_set_psk_find_session_callback := LoadFunction('SSL_set_psk_find_session_callback', LFailed);
    SSL_CTX_set_psk_find_session_callback := LoadFunction('SSL_CTX_set_psk_find_session_callback', LFailed);
    SSL_set_psk_use_session_callback := LoadFunction('SSL_set_psk_use_session_callback', LFailed);
    SSL_CTX_set_psk_use_session_callback := LoadFunction('SSL_CTX_set_psk_use_session_callback', LFailed);
    SSL_CTX_set_keylog_callback := LoadFunction('SSL_CTX_set_keylog_callback', LFailed);
    SSL_CTX_get_keylog_callback := LoadFunction('SSL_CTX_get_keylog_callback', LFailed);
    SSL_CTX_set_max_early_data := LoadFunction('SSL_CTX_set_max_early_data', LFailed);
    SSL_CTX_get_max_early_data := LoadFunction('SSL_CTX_get_max_early_data', LFailed);
    SSL_set_max_early_data := LoadFunction('SSL_set_max_early_data', LFailed);
    SSL_get_max_early_data := LoadFunction('SSL_get_max_early_data', LFailed);
    SSL_CTX_set_recv_max_early_data := LoadFunction('SSL_CTX_set_recv_max_early_data', LFailed);
    SSL_CTX_get_recv_max_early_data := LoadFunction('SSL_CTX_get_recv_max_early_data', LFailed);
    SSL_set_recv_max_early_data := LoadFunction('SSL_set_recv_max_early_data', LFailed);
    SSL_get_recv_max_early_data := LoadFunction('SSL_get_recv_max_early_data', LFailed);
    SSL_in_init := LoadFunction('SSL_in_init', LFailed);
    SSL_in_before := LoadFunction('SSL_in_before', LFailed);
    SSL_is_init_finished := LoadFunction('SSL_is_init_finished', LFailed);
    SSL_get_finished := LoadFunction('SSL_get_finished', LFailed);
    SSL_get_peer_finished := LoadFunction('SSL_get_peer_finished', LFailed);
    BIO_f_ssl := LoadFunction('BIO_f_ssl', LFailed);
    BIO_new_ssl := LoadFunction('BIO_new_ssl', LFailed);
    BIO_new_ssl_connect := LoadFunction('BIO_new_ssl_connect', LFailed);
    BIO_new_buffer_ssl_connect := LoadFunction('BIO_new_buffer_ssl_connect', LFailed);
    BIO_ssl_copy_session_id := LoadFunction('BIO_ssl_copy_session_id', LFailed);
    SSL_CTX_set_cipher_list := LoadFunction('SSL_CTX_set_cipher_list', LFailed);
    SSL_CTX_new := LoadFunction('SSL_CTX_new', LFailed);
    SSL_CTX_set_timeout := LoadFunction('SSL_CTX_set_timeout', LFailed);
    SSL_CTX_get_timeout := LoadFunction('SSL_CTX_get_timeout', LFailed);
    SSL_CTX_get_cert_store := LoadFunction('SSL_CTX_get_cert_store', LFailed);
    SSL_want := LoadFunction('SSL_want', LFailed);
    SSL_clear := LoadFunction('SSL_clear', LFailed);
    BIO_ssl_shutdown := LoadFunction('BIO_ssl_shutdown', LFailed);
    SSL_CTX_up_ref := LoadFunction('SSL_CTX_up_ref', LFailed);
    SSL_CTX_free := LoadFunction('SSL_CTX_free', LFailed);
    SSL_CTX_set_cert_store := LoadFunction('SSL_CTX_set_cert_store', LFailed);
    SSL_CTX_set1_cert_store := LoadFunction('SSL_CTX_set1_cert_store', LFailed);
    SSL_CTX_flush_sessions := LoadFunction('SSL_CTX_flush_sessions', LFailed);
    SSL_get_current_cipher := LoadFunction('SSL_get_current_cipher', LFailed);
    SSL_get_pending_cipher := LoadFunction('SSL_get_pending_cipher', LFailed);
    SSL_CIPHER_get_bits := LoadFunction('SSL_CIPHER_get_bits', LFailed);
    SSL_CIPHER_get_version := LoadFunction('SSL_CIPHER_get_version', LFailed);
    SSL_CIPHER_get_name := LoadFunction('SSL_CIPHER_get_name', LFailed);
    SSL_CIPHER_standard_name := LoadFunction('SSL_CIPHER_standard_name', LFailed);
    OPENSSL_cipher_name := LoadFunction('OPENSSL_cipher_name', LFailed);
    SSL_CIPHER_get_id := LoadFunction('SSL_CIPHER_get_id', LFailed);
    SSL_CIPHER_get_protocol_id := LoadFunction('SSL_CIPHER_get_protocol_id', LFailed);
    SSL_CIPHER_get_kx_nid := LoadFunction('SSL_CIPHER_get_kx_nid', LFailed);
    SSL_CIPHER_get_auth_nid := LoadFunction('SSL_CIPHER_get_auth_nid', LFailed);
    SSL_CIPHER_get_handshake_digest := LoadFunction('SSL_CIPHER_get_handshake_digest', LFailed);
    SSL_CIPHER_is_aead := LoadFunction('SSL_CIPHER_is_aead', LFailed);
    SSL_get_fd := LoadFunction('SSL_get_fd', LFailed);
    SSL_get_rfd := LoadFunction('SSL_get_rfd', LFailed);
    SSL_get_wfd := LoadFunction('SSL_get_wfd', LFailed);
    SSL_get_cipher_list := LoadFunction('SSL_get_cipher_list', LFailed);
    SSL_get_shared_ciphers := LoadFunction('SSL_get_shared_ciphers', LFailed);
    SSL_get_read_ahead := LoadFunction('SSL_get_read_ahead', LFailed);
    SSL_pending := LoadFunction('SSL_pending', LFailed);
    SSL_has_pending := LoadFunction('SSL_has_pending', LFailed);
    SSL_set_fd := LoadFunction('SSL_set_fd', LFailed);
    SSL_set_rfd := LoadFunction('SSL_set_rfd', LFailed);
    SSL_set_wfd := LoadFunction('SSL_set_wfd', LFailed);
    SSL_set0_rbio := LoadFunction('SSL_set0_rbio', LFailed);
    SSL_set0_wbio := LoadFunction('SSL_set0_wbio', LFailed);
    SSL_set_bio := LoadFunction('SSL_set_bio', LFailed);
    SSL_get_rbio := LoadFunction('SSL_get_rbio', LFailed);
    SSL_get_wbio := LoadFunction('SSL_get_wbio', LFailed);
    SSL_set_cipher_list := LoadFunction('SSL_set_cipher_list', LFailed);
    SSL_CTX_set_ciphersuites := LoadFunction('SSL_CTX_set_ciphersuites', LFailed);
    SSL_set_ciphersuites := LoadFunction('SSL_set_ciphersuites', LFailed);
    SSL_get_verify_mode := LoadFunction('SSL_get_verify_mode', LFailed);
    SSL_get_verify_depth := LoadFunction('SSL_get_verify_depth', LFailed);
    SSL_get_verify_callback := LoadFunction('SSL_get_verify_callback', LFailed);
    SSL_set_read_ahead := LoadFunction('SSL_set_read_ahead', LFailed);
    SSL_set_verify := LoadFunction('SSL_set_verify', LFailed);
    SSL_set_verify_depth := LoadFunction('SSL_set_verify_depth', LFailed);
    SSL_use_RSAPrivateKey := LoadFunction('SSL_use_RSAPrivateKey', LFailed);
    SSL_use_RSAPrivateKey_ASN1 := LoadFunction('SSL_use_RSAPrivateKey_ASN1', LFailed);
    SSL_use_PrivateKey := LoadFunction('SSL_use_PrivateKey', LFailed);
    SSL_use_PrivateKey_ASN1 := LoadFunction('SSL_use_PrivateKey_ASN1', LFailed);
    SSL_use_certificate := LoadFunction('SSL_use_certificate', LFailed);
    SSL_use_certificate_ASN1 := LoadFunction('SSL_use_certificate_ASN1', LFailed);
    SSL_CTX_use_serverinfo := LoadFunction('SSL_CTX_use_serverinfo', LFailed);
    SSL_CTX_use_serverinfo_ex := LoadFunction('SSL_CTX_use_serverinfo_ex', LFailed);
    SSL_CTX_use_serverinfo_file := LoadFunction('SSL_CTX_use_serverinfo_file', LFailed);
    SSL_use_RSAPrivateKey_file := LoadFunction('SSL_use_RSAPrivateKey_file', LFailed);
    SSL_use_PrivateKey_file := LoadFunction('SSL_use_PrivateKey_file', LFailed);
    SSL_use_certificate_file := LoadFunction('SSL_use_certificate_file', LFailed);
    SSL_CTX_use_RSAPrivateKey_file := LoadFunction('SSL_CTX_use_RSAPrivateKey_file', LFailed);
    SSL_CTX_use_PrivateKey_file := LoadFunction('SSL_CTX_use_PrivateKey_file', LFailed);
    SSL_CTX_use_certificate_file := LoadFunction('SSL_CTX_use_certificate_file', LFailed);
    SSL_CTX_use_certificate_chain_file := LoadFunction('SSL_CTX_use_certificate_chain_file', LFailed);
    SSL_use_certificate_chain_file := LoadFunction('SSL_use_certificate_chain_file', LFailed);
    SSL_state_string := LoadFunction('SSL_state_string', LFailed);
    SSL_rstate_string := LoadFunction('SSL_rstate_string', LFailed);
    SSL_state_string_long := LoadFunction('SSL_state_string_long', LFailed);
    SSL_rstate_string_long := LoadFunction('SSL_rstate_string_long', LFailed);
    SSL_SESSION_get_time := LoadFunction('SSL_SESSION_get_time', LFailed);
    SSL_SESSION_set_time := LoadFunction('SSL_SESSION_set_time', LFailed);
    SSL_SESSION_get_timeout := LoadFunction('SSL_SESSION_get_timeout', LFailed);
    SSL_SESSION_set_timeout := LoadFunction('SSL_SESSION_set_timeout', LFailed);
    SSL_SESSION_get_protocol_version := LoadFunction('SSL_SESSION_get_protocol_version', LFailed);
    SSL_SESSION_set_protocol_version := LoadFunction('SSL_SESSION_set_protocol_version', LFailed);
    SSL_SESSION_get0_hostname := LoadFunction('SSL_SESSION_get0_hostname', LFailed);
    SSL_SESSION_set1_hostname := LoadFunction('SSL_SESSION_set1_hostname', LFailed);
    SSL_SESSION_get0_alpn_selected := LoadFunction('SSL_SESSION_get0_alpn_selected', LFailed);
    SSL_SESSION_set1_alpn_selected := LoadFunction('SSL_SESSION_set1_alpn_selected', LFailed);
    SSL_SESSION_get0_cipher := LoadFunction('SSL_SESSION_get0_cipher', LFailed);
    SSL_SESSION_set_cipher := LoadFunction('SSL_SESSION_set_cipher', LFailed);
    SSL_SESSION_has_ticket := LoadFunction('SSL_SESSION_has_ticket', LFailed);
    SSL_SESSION_get_ticket_lifetime_hint := LoadFunction('SSL_SESSION_get_ticket_lifetime_hint', LFailed);
    SSL_SESSION_get0_ticket := LoadFunction('SSL_SESSION_get0_ticket', LFailed);
    SSL_SESSION_get_max_early_data := LoadFunction('SSL_SESSION_get_max_early_data', LFailed);
    SSL_SESSION_set_max_early_data := LoadFunction('SSL_SESSION_set_max_early_data', LFailed);
    SSL_copy_session_id := LoadFunction('SSL_copy_session_id', LFailed);
    SSL_SESSION_get0_peer := LoadFunction('SSL_SESSION_get0_peer', LFailed);
    SSL_SESSION_set1_id_context := LoadFunction('SSL_SESSION_set1_id_context', LFailed);
    SSL_SESSION_set1_id := LoadFunction('SSL_SESSION_set1_id', LFailed);
    SSL_SESSION_is_resumable := LoadFunction('SSL_SESSION_is_resumable', LFailed);
    SSL_SESSION_new := LoadFunction('SSL_SESSION_new', LFailed);
    SSL_SESSION_dup := LoadFunction('SSL_SESSION_dup', LFailed);
    SSL_SESSION_get_id := LoadFunction('SSL_SESSION_get_id', LFailed);
    SSL_SESSION_get0_id_context := LoadFunction('SSL_SESSION_get0_id_context', LFailed);
    SSL_SESSION_get_compress_id := LoadFunction('SSL_SESSION_get_compress_id', LFailed);
    SSL_SESSION_print := LoadFunction('SSL_SESSION_print', LFailed);
    SSL_SESSION_print_keylog := LoadFunction('SSL_SESSION_print_keylog', LFailed);
    SSL_SESSION_up_ref := LoadFunction('SSL_SESSION_up_ref', LFailed);
    SSL_SESSION_free := LoadFunction('SSL_SESSION_free', LFailed);
    SSL_set_session := LoadFunction('SSL_set_session', LFailed);
    SSL_CTX_add_session := LoadFunction('SSL_CTX_add_session', LFailed);
    SSL_CTX_remove_session := LoadFunction('SSL_CTX_remove_session', LFailed);
    SSL_CTX_set_generate_session_id := LoadFunction('SSL_CTX_set_generate_session_id', LFailed);
    SSL_set_generate_session_id := LoadFunction('SSL_set_generate_session_id', LFailed);
    SSL_has_matching_session_id := LoadFunction('SSL_has_matching_session_id', LFailed);
    d2i_SSL_SESSION := LoadFunction('d2i_SSL_SESSION', LFailed);
    SSL_get_peer_certificate := LoadFunction('SSL_get_peer_certificate', LFailed);
    SSL_CTX_get_verify_mode := LoadFunction('SSL_CTX_get_verify_mode', LFailed);
    SSL_CTX_get_verify_depth := LoadFunction('SSL_CTX_get_verify_depth', LFailed);
    SSL_CTX_get_verify_callback := LoadFunction('SSL_CTX_get_verify_callback', LFailed);
    SSL_CTX_set_verify := LoadFunction('SSL_CTX_set_verify', LFailed);
    SSL_CTX_set_verify_depth := LoadFunction('SSL_CTX_set_verify_depth', LFailed);
    SSL_CTX_set_cert_verify_callback := LoadFunction('SSL_CTX_set_cert_verify_callback', LFailed);
    SSL_CTX_set_cert_cb := LoadFunction('SSL_CTX_set_cert_cb', LFailed);
    SSL_CTX_use_RSAPrivateKey := LoadFunction('SSL_CTX_use_RSAPrivateKey', LFailed);
    SSL_CTX_use_RSAPrivateKey_ASN1 := LoadFunction('SSL_CTX_use_RSAPrivateKey_ASN1', LFailed);
    SSL_CTX_use_PrivateKey := LoadFunction('SSL_CTX_use_PrivateKey', LFailed);
    SSL_CTX_use_PrivateKey_ASN1 := LoadFunction('SSL_CTX_use_PrivateKey_ASN1', LFailed);
    SSL_CTX_use_certificate := LoadFunction('SSL_CTX_use_certificate', LFailed);
    SSL_CTX_use_certificate_ASN1 := LoadFunction('SSL_CTX_use_certificate_ASN1', LFailed);
    SSL_CTX_set_default_passwd_cb := LoadFunction('SSL_CTX_set_default_passwd_cb', LFailed);
    SSL_CTX_set_default_passwd_cb_userdata := LoadFunction('SSL_CTX_set_default_passwd_cb_userdata', LFailed);
    SSL_CTX_get_default_passwd_cb := LoadFunction('SSL_CTX_get_default_passwd_cb', LFailed);
    SSL_CTX_get_default_passwd_cb_userdata := LoadFunction('SSL_CTX_get_default_passwd_cb_userdata', LFailed);
    SSL_set_default_passwd_cb := LoadFunction('SSL_set_default_passwd_cb', LFailed);
    SSL_set_default_passwd_cb_userdata := LoadFunction('SSL_set_default_passwd_cb_userdata', LFailed);
    SSL_get_default_passwd_cb := LoadFunction('SSL_get_default_passwd_cb', LFailed);
    SSL_get_default_passwd_cb_userdata := LoadFunction('SSL_get_default_passwd_cb_userdata', LFailed);
    SSL_CTX_check_private_key := LoadFunction('SSL_CTX_check_private_key', LFailed);
    SSL_check_private_key := LoadFunction('SSL_check_private_key', LFailed);
    SSL_CTX_set_session_id_context := LoadFunction('SSL_CTX_set_session_id_context', LFailed);
    SSL_new := LoadFunction('SSL_new', LFailed);
    SSL_up_ref := LoadFunction('SSL_up_ref', LFailed);
    SSL_is_dtls := LoadFunction('SSL_is_dtls', LFailed);
    SSL_set_session_id_context := LoadFunction('SSL_set_session_id_context', LFailed);
    SSL_CTX_set_purpose := LoadFunction('SSL_CTX_set_purpose', LFailed);
    SSL_set_purpose := LoadFunction('SSL_set_purpose', LFailed);
    SSL_CTX_set_trust := LoadFunction('SSL_CTX_set_trust', LFailed);
    SSL_set_trust := LoadFunction('SSL_set_trust', LFailed);
    SSL_set1_host := LoadFunction('SSL_set1_host', LFailed);
    SSL_add1_host := LoadFunction('SSL_add1_host', LFailed);
    SSL_get0_peername := LoadFunction('SSL_get0_peername', LFailed);
    SSL_set_hostflags := LoadFunction('SSL_set_hostflags', LFailed);
    SSL_CTX_dane_enable := LoadFunction('SSL_CTX_dane_enable', LFailed);
    SSL_CTX_dane_mtype_set := LoadFunction('SSL_CTX_dane_mtype_set', LFailed);
    SSL_dane_enable := LoadFunction('SSL_dane_enable', LFailed);
    SSL_dane_tlsa_add := LoadFunction('SSL_dane_tlsa_add', LFailed);
    SSL_get0_dane_authority := LoadFunction('SSL_get0_dane_authority', LFailed);
    SSL_get0_dane_tlsa := LoadFunction('SSL_get0_dane_tlsa', LFailed);
    SSL_get0_dane := LoadFunction('SSL_get0_dane', LFailed);
    SSL_CTX_dane_set_flags := LoadFunction('SSL_CTX_dane_set_flags', LFailed);
    SSL_CTX_dane_clear_flags := LoadFunction('SSL_CTX_dane_clear_flags', LFailed);
    SSL_dane_set_flags := LoadFunction('SSL_dane_set_flags', LFailed);
    SSL_dane_clear_flags := LoadFunction('SSL_dane_clear_flags', LFailed);
    SSL_CTX_set1_param := LoadFunction('SSL_CTX_set1_param', LFailed);
    SSL_set1_param := LoadFunction('SSL_set1_param', LFailed);
    SSL_CTX_get0_param := LoadFunction('SSL_CTX_get0_param', LFailed);
    SSL_get0_param := LoadFunction('SSL_get0_param', LFailed);
    SSL_CTX_set_srp_username := LoadFunction('SSL_CTX_set_srp_username', LFailed);
    SSL_CTX_set_srp_password := LoadFunction('SSL_CTX_set_srp_password', LFailed);
    SSL_CTX_set_srp_strength := LoadFunction('SSL_CTX_set_srp_strength', LFailed);
    SSL_CTX_set_srp_client_pwd_callback := LoadFunction('SSL_CTX_set_srp_client_pwd_callback', LFailed);
    SSL_CTX_set_srp_verify_param_callback := LoadFunction('SSL_CTX_set_srp_verify_param_callback', LFailed);
    SSL_CTX_set_srp_username_callback := LoadFunction('SSL_CTX_set_srp_username_callback', LFailed);
    SSL_CTX_set_srp_cb_arg := LoadFunction('SSL_CTX_set_srp_cb_arg', LFailed);
    SSL_set_srp_server_param := LoadFunction('SSL_set_srp_server_param', LFailed);
    SSL_set_srp_server_param_pw := LoadFunction('SSL_set_srp_server_param_pw', LFailed);
    SSL_CTX_set_client_hello_cb := LoadFunction('SSL_CTX_set_client_hello_cb', LFailed);
    SSL_client_hello_isv2 := LoadFunction('SSL_client_hello_isv2', LFailed);
    SSL_client_hello_get0_legacy_version := LoadFunction('SSL_client_hello_get0_legacy_version', LFailed);
    SSL_client_hello_get0_random := LoadFunction('SSL_client_hello_get0_random', LFailed);
    SSL_client_hello_get0_session_id := LoadFunction('SSL_client_hello_get0_session_id', LFailed);
    SSL_client_hello_get0_ciphers := LoadFunction('SSL_client_hello_get0_ciphers', LFailed);
    SSL_client_hello_get0_compression_methods := LoadFunction('SSL_client_hello_get0_compression_methods', LFailed);
    SSL_client_hello_get1_extensions_present := LoadFunction('SSL_client_hello_get1_extensions_present', LFailed);
    SSL_client_hello_get0_ext := LoadFunction('SSL_client_hello_get0_ext', LFailed);
    SSL_certs_clear := LoadFunction('SSL_certs_clear', LFailed);
    SSL_free := LoadFunction('SSL_free', LFailed);
    SSL_waiting_for_async := LoadFunction('SSL_waiting_for_async', LFailed);
    SSL_get_all_async_fds := LoadFunction('SSL_get_all_async_fds', LFailed);
    SSL_get_changed_async_fds := LoadFunction('SSL_get_changed_async_fds', LFailed);
    SSL_accept := LoadFunction('SSL_accept', LFailed);
    SSL_stateless := LoadFunction('SSL_stateless', LFailed);
    SSL_connect := LoadFunction('SSL_connect', LFailed);
    SSL_read := LoadFunction('SSL_read', LFailed);
    SSL_read_ex := LoadFunction('SSL_read_ex', LFailed);
    SSL_read_early_data := LoadFunction('SSL_read_early_data', LFailed);
    SSL_peek := LoadFunction('SSL_peek', LFailed);
    SSL_peek_ex := LoadFunction('SSL_peek_ex', LFailed);
    SSL_write := LoadFunction('SSL_write', LFailed);
    SSL_write_ex := LoadFunction('SSL_write_ex', LFailed);
    SSL_write_early_data := LoadFunction('SSL_write_early_data', LFailed);
    SSL_callback_ctrl := LoadFunction('SSL_callback_ctrl', LFailed);
    SSL_ctrl := LoadFunction('SSL_ctrl', LFailed);
    SSL_CTX_ctrl := LoadFunction('SSL_CTX_ctrl', LFailed);
    SSL_CTX_callback_ctrl := LoadFunction('SSL_CTX_callback_ctrl', LFailed);
    SSL_get_early_data_status := LoadFunction('SSL_get_early_data_status', LFailed);
    SSL_get_error := LoadFunction('SSL_get_error', LFailed);
    SSL_get_version := LoadFunction('SSL_get_version', LFailed);
    SSL_CTX_set_ssl_version := LoadFunction('SSL_CTX_set_ssl_version', LFailed);
    TLS_method := LoadFunction('TLS_method', LFailed);
    TLS_server_method := LoadFunction('TLS_server_method', LFailed);
    TLS_client_method := LoadFunction('TLS_client_method', LFailed);
    SSL_key_update := LoadFunction('SSL_key_update', LFailed);
    SSL_get_key_update_type := LoadFunction('SSL_get_key_update_type', LFailed);
    SSL_renegotiate := LoadFunction('SSL_renegotiate', LFailed);
    SSL_renegotiate_abbreviated := LoadFunction('SSL_renegotiate_abbreviated', LFailed);
    SSL_shutdown := LoadFunction('SSL_shutdown', LFailed);
    SSL_CTX_set_post_handshake_auth := LoadFunction('SSL_CTX_set_post_handshake_auth', LFailed);
    SSL_set_post_handshake_auth := LoadFunction('SSL_set_post_handshake_auth', LFailed);
    SSL_renegotiate_pending := LoadFunction('SSL_renegotiate_pending', LFailed);
    SSL_verify_client_post_handshake := LoadFunction('SSL_verify_client_post_handshake', LFailed);
    SSL_CTX_get_ssl_method := LoadFunction('SSL_CTX_get_ssl_method', LFailed);
    SSL_get_ssl_method := LoadFunction('SSL_get_ssl_method', LFailed);
    SSL_set_ssl_method := LoadFunction('SSL_set_ssl_method', LFailed);
    SSL_alert_type_string_long := LoadFunction('SSL_alert_type_string_long', LFailed);
    SSL_alert_type_string := LoadFunction('SSL_alert_type_string', LFailed);
    SSL_alert_desc_string_long := LoadFunction('SSL_alert_desc_string_long', LFailed);
    SSL_alert_desc_string := LoadFunction('SSL_alert_desc_string', LFailed);
    SSL_add_client_CA := LoadFunction('SSL_add_client_CA', LFailed);
    SSL_CTX_add_client_CA := LoadFunction('SSL_CTX_add_client_CA', LFailed);
    SSL_set_connect_state := LoadFunction('SSL_set_connect_state', LFailed);
    SSL_set_accept_state := LoadFunction('SSL_set_accept_state', LFailed);
    SSL_dup := LoadFunction('SSL_dup', LFailed);
    SSL_get_certificate := LoadFunction('SSL_get_certificate', LFailed);
    SSL_get_privatekey := LoadFunction('SSL_get_privatekey', LFailed);
    SSL_CTX_get0_certificate := LoadFunction('SSL_CTX_get0_certificate', LFailed);
    SSL_CTX_get0_privatekey := LoadFunction('SSL_CTX_get0_privatekey', LFailed);
    SSL_CTX_set_quiet_shutdown := LoadFunction('SSL_CTX_set_quiet_shutdown', LFailed);
    SSL_CTX_get_quiet_shutdown := LoadFunction('SSL_CTX_get_quiet_shutdown', LFailed);
    SSL_set_quiet_shutdown := LoadFunction('SSL_set_quiet_shutdown', LFailed);
    SSL_get_quiet_shutdown := LoadFunction('SSL_get_quiet_shutdown', LFailed);
    SSL_set_shutdown := LoadFunction('SSL_set_shutdown', LFailed);
    SSL_get_shutdown := LoadFunction('SSL_get_shutdown', LFailed);
    SSL_version := LoadFunction('SSL_version', LFailed);
    SSL_client_version := LoadFunction('SSL_client_version', LFailed);
    SSL_CTX_set_default_verify_paths := LoadFunction('SSL_CTX_set_default_verify_paths', LFailed);
    SSL_CTX_set_default_verify_dir := LoadFunction('SSL_CTX_set_default_verify_dir', LFailed);
    SSL_CTX_set_default_verify_file := LoadFunction('SSL_CTX_set_default_verify_file', LFailed);
    SSL_CTX_load_verify_locations := LoadFunction('SSL_CTX_load_verify_locations', LFailed);
    SSL_get_session := LoadFunction('SSL_get_session', LFailed);
    SSL_get1_session := LoadFunction('SSL_get1_session', LFailed);
    SSL_get_SSL_CTX := LoadFunction('SSL_get_SSL_CTX', LFailed);
    SSL_set_SSL_CTX := LoadFunction('SSL_set_SSL_CTX', LFailed);
    SSL_set_info_callback := LoadFunction('SSL_set_info_callback', LFailed);
    SSL_get_info_callback := LoadFunction('SSL_get_info_callback', LFailed);
    SSL_get_state := LoadFunction('SSL_get_state', LFailed);
    SSL_set_verify_result := LoadFunction('SSL_set_verify_result', LFailed);
    SSL_get_verify_result := LoadFunction('SSL_get_verify_result', LFailed);
    SSL_get_client_random := LoadFunction('SSL_get_client_random', LFailed);
    SSL_get_server_random := LoadFunction('SSL_get_server_random', LFailed);
    SSL_SESSION_get_master_key := LoadFunction('SSL_SESSION_get_master_key', LFailed);
    SSL_SESSION_set1_master_key := LoadFunction('SSL_SESSION_set1_master_key', LFailed);
    SSL_SESSION_get_max_fragment_length := LoadFunction('SSL_SESSION_get_max_fragment_length', LFailed);
    SSL_set_ex_data := LoadFunction('SSL_set_ex_data', LFailed);
    SSL_get_ex_data := LoadFunction('SSL_get_ex_data', LFailed);
    SSL_SESSION_set_ex_data := LoadFunction('SSL_SESSION_set_ex_data', LFailed);
    ...
    SSL_set_tmp_dh_callback := LoadFunction('SSL_set_tmp_dh_callback', LFailed);
    SSL_CIPHER_find := LoadFunction('SSL_CIPHER_find', LFailed);
    SSL_CIPHER_get_cipher_nid := LoadFunction('SSL_CIPHER_get_cipher_nid', LFailed);
    SSL_CIPHER_get_digest_nid := LoadFunction('SSL_CIPHER_get_digest_nid', LFailed);
    SSL_set_session_ticket_ext := LoadFunction('SSL_set_session_ticket_ext', LFailed);
    SSL_set_session_ticket_ext_cb := LoadFunction('SSL_set_session_ticket_ext_cb', LFailed);
    SSL_CTX_set_not_resumable_session_callback := LoadFunction('SSL_CTX_set_not_resumable_session_callback', LFailed);
    SSL_set_not_resumable_session_callback := LoadFunction('SSL_set_not_resumable_session_callback', LFailed);
    SSL_CTX_set_record_padding_callback := LoadFunction('SSL_CTX_set_record_padding_callback', LFailed);
    SSL_CTX_set_record_padding_callback_arg := LoadFunction('SSL_CTX_set_record_padding_callback_arg', LFailed);
    SSL_CTX_get_record_padding_callback_arg := LoadFunction('SSL_CTX_get_record_padding_callback_arg', LFailed);
    SSL_CTX_set_block_padding := LoadFunction('SSL_CTX_set_block_padding', LFailed);
    SSL_set_record_padding_callback := LoadFunction('SSL_set_record_padding_callback', LFailed);
    SSL_set_record_padding_callback_arg := LoadFunction('SSL_set_record_padding_callback_arg', LFailed);
    SSL_get_record_padding_callback_arg := LoadFunction('SSL_get_record_padding_callback_arg', LFailed);
    SSL_set_block_padding := LoadFunction('SSL_set_block_padding', LFailed);
    SSL_set_num_tickets := LoadFunction('SSL_set_num_tickets', LFailed);
    SSL_get_num_tickets := LoadFunction('SSL_get_num_tickets', LFailed);
    SSL_CTX_set_num_tickets := LoadFunction('SSL_CTX_set_num_tickets', LFailed);
    SSL_CTX_get_num_tickets := LoadFunction('SSL_CTX_get_num_tickets', LFailed);
    SSL_session_reused := LoadFunction('SSL_session_reused', LFailed);
    SSL_is_server := LoadFunction('SSL_is_server', LFailed);
    SSL_CONF_CTX_new := LoadFunction('SSL_CONF_CTX_new', LFailed);
    SSL_CONF_CTX_finish := LoadFunction('SSL_CONF_CTX_finish', LFailed);
    SSL_CONF_CTX_free := LoadFunction('SSL_CONF_CTX_free', LFailed);
    SSL_CONF_CTX_set_flags := LoadFunction('SSL_CONF_CTX_set_flags', LFailed);
    SSL_CONF_CTX_clear_flags := LoadFunction('SSL_CONF_CTX_clear_flags', LFailed);
    SSL_CONF_CTX_set1_prefix := LoadFunction('SSL_CONF_CTX_set1_prefix', LFailed);
    SSL_CONF_cmd := LoadFunction('SSL_CONF_cmd', LFailed);
    SSL_CONF_cmd_argv := LoadFunction('SSL_CONF_cmd_argv', LFailed);
    SSL_CONF_cmd_value_type := LoadFunction('SSL_CONF_cmd_value_type', LFailed);
    SSL_CONF_CTX_set_ssl := LoadFunction('SSL_CONF_CTX_set_ssl', LFailed);
    SSL_CONF_CTX_set_ssl_ctx := LoadFunction('SSL_CONF_CTX_set_ssl_ctx', LFailed);
    SSL_add_ssl_module := LoadFunction('SSL_add_ssl_module', LFailed);
    SSL_config := LoadFunction('SSL_config', LFailed);
    SSL_CTX_config := LoadFunction('SSL_CTX_config', LFailed);
    SSL_trace := LoadFunction('SSL_trace', LFailed);
    DTLSv1_listen := LoadFunction('DTLSv1_listen', LFailed);
    SSL_enable_ct := LoadFunction('SSL_enable_ct', LFailed);
    SSL_CTX_enable_ct := LoadFunction('SSL_CTX_enable_ct', LFailed);
    SSL_ct_is_enabled := LoadFunction('SSL_ct_is_enabled', LFailed);
    SSL_CTX_ct_is_enabled := LoadFunction('SSL_CTX_ct_is_enabled', LFailed);
    SSL_CTX_set_default_ctlog_list_file := LoadFunction('SSL_CTX_set_default_ctlog_list_file', LFailed);
    SSL_CTX_set_ctlog_list_file := LoadFunction('SSL_CTX_set_ctlog_list_file', LFailed);
    SSL_CTX_set0_ctlog_store := LoadFunction('SSL_CTX_set0_ctlog_store', LFailed);
    SSL_set_security_level := LoadFunction('SSL_set_security_level', LFailed);
    SSL_set_security_callback := LoadFunction('SSL_set_security_callback', LFailed);
    SSL_get_security_callback := LoadFunction('SSL_get_security_callback', LFailed);
    SSL_set0_security_ex_data := LoadFunction('SSL_set0_security_ex_data', LFailed);
    SSL_get0_security_ex_data := LoadFunction('SSL_get0_security_ex_data', LFailed);
    SSL_CTX_set_security_level := LoadFunction('SSL_CTX_set_security_level', LFailed);
    SSL_CTX_get_security_level := LoadFunction('SSL_CTX_get_security_level', LFailed);
    SSL_CTX_get0_security_ex_data := LoadFunction('SSL_CTX_get0_security_ex_data', LFailed);
    SSL_CTX_set0_security_ex_data := LoadFunction('SSL_CTX_set0_security_ex_data', LFailed);
    OPENSSL_init_ssl := LoadFunction('OPENSSL_init_ssl', LFailed);
    SSL_free_buffers := LoadFunction('SSL_free_buffers', LFailed);
    SSL_alloc_buffers := LoadFunction('SSL_alloc_buffers', LFailed);
    SSL_CTX_set_session_ticket_cb := LoadFunction('SSL_CTX_set_session_ticket_cb', LFailed);
    SSL_SESSION_set1_ticket_appdata := LoadFunction('SSL_SESSION_set1_ticket_appdata', LFailed);
    SSL_SESSION_get0_ticket_appdata := LoadFunction('SSL_SESSION_get0_ticket_appdata', LFailed);
    DTLS_set_timer_cb := LoadFunction('DTLS_set_timer_cb', LFailed);
    SSL_CTX_set_allow_early_data_cb := LoadFunction('SSL_CTX_set_allow_early_data_cb', LFailed);
    SSL_set_allow_early_data_cb := LoadFunction('SSL_set_allow_early_data_cb', LFailed);

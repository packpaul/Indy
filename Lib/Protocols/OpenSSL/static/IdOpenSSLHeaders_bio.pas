...
function BIO_do_handshake(b: PBIO): TIdC_LONG;
  ...
  function BIO_get_new_index: TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_set_flags(b: PBIO; flags: TIdC_INT) cdecl; external 'libcrypto-1_1.dll';
  function BIO_test_flags(const b: PBIO; flags: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_clear_flags(b: PBIO; flags: TIdC_INT) cdecl; external 'libcrypto-1_1.dll';

  function BIO_get_callback(b: PBIO): BIO_callback_fn cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_set_callback(b: PBIO; callback: BIO_callback_fn) cdecl; external 'libcrypto-1_1.dll';

  function BIO_get_callback_ex(b: PBIO): BIO_callback_fn_ex cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_set_callback_ex(b: PBIO; callback: BIO_callback_fn_ex) cdecl; external 'libcrypto-1_1.dll';

  function BIO_get_callback_arg(const b: PBIO): PIdAnsiChar cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_set_callback_arg(var b: PBIO; arg: PIdAnsiChar) cdecl; external 'libcrypto-1_1.dll';

  function BIO_method_name(const b: PBIO): PIdAnsiChar cdecl; external 'libcrypto-1_1.dll';
  function BIO_method_type(const b: PBIO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
...
//  {$HPPEMIT '# define BIO_wpending(b)         (int)BIO_ctrl(b,BIO_CTRL_WPENDING,0,NULL)'}
  ...
  function BIO_ctrl_pending(b: PBIO): TIdC_SIZET cdecl; external 'libcrypto-1_1.dll';
  function BIO_ctrl_wpending(b: PBIO): TIdC_SIZET cdecl; external 'libcrypto-1_1.dll';
...
//  {$HPPEMIT '# define BIO_get_read_request(b)    (int)BIO_ctrl(b,BIO_C_GET_READ_REQUEST,0,NULL)'}
  function BIO_ctrl_get_write_guarantee(b: PBIO): TIdC_SIZET cdecl; external 'libcrypto-1_1.dll';
  function BIO_ctrl_get_read_request(b: PBIO): TIdC_SIZET cdecl; external 'libcrypto-1_1.dll';
  function BIO_ctrl_reset_read_request(b: PBIO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
...
//    CRYPTO_get_ex_new_index(CRYPTO_EX_INDEX_BIO, l, p, newf, dupf, freef)
  ...
  function BIO_set_ex_data(bio: PBIO; idx: TIdC_INT; data: Pointer): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_get_ex_data(bio: PBIO; idx: TIdC_INT): Pointer cdecl; external 'libcrypto-1_1.dll';
  function BIO_number_read(bio: PBIO): TIdC_UINT64 cdecl; external 'libcrypto-1_1.dll';
  function BIO_number_written(bio: PBIO): TIdC_UINT64 cdecl; external 'libcrypto-1_1.dll';
...
//  function BIO_asn1_get_suffix(b: PBIO; psuffix: ^asn1_ps_func; psuffix_free: ^^asn1_ps_func): TIdC_INT;
  ...
  function BIO_s_file: PBIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_new_file(const filename: PIdAnsiChar; const mode: PIdAnsiChar): PBIO cdecl; external 'libcrypto-1_1.dll';
//  function BIO_new_fp(stream: cFile; close_flag: TIdC_INT): PBIO;
  function BIO_new(const cType: PBIO_METHOD): PBIO cdecl; external 'libcrypto-1_1.dll';
  function BIO_free(a: PBIO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_set_data(a: PBIO; ptr: Pointer) cdecl; external 'libcrypto-1_1.dll';
  function BIO_get_data(a: PBIO): Pointer cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_set_init(a: PBIO; init: TIdC_INT) cdecl; external 'libcrypto-1_1.dll';
  function BIO_get_init(a: PBIO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_set_shutdown(a: PBIO; shut: TIdC_INT) cdecl; external 'libcrypto-1_1.dll';
  function BIO_get_shutdown(a: PBIO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_vfree(a: PBIO) cdecl; external 'libcrypto-1_1.dll';
  function BIO_up_ref(a: PBIO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_read(b: PBIO; data: Pointer; dlen: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_read_ex(b: PBIO; data: Pointer; dlen: TIdC_SIZET; readbytes: PIdC_SIZET): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_gets( bp: PBIO; buf: PIdAnsiChar; size: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_write(b: PBIO; const data: Pointer; dlen: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_write_ex(b: PBIO; const data: Pointer; dlen: TIdC_SIZET; written: PIdC_SIZET): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_puts(bp: PBIO; const buf: PIdAnsiChar): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_indent(b: PBIO; indent: TIdC_INT; max: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_ctrl(bp: PBIO; cmd: TIdC_INT; larg: TIdC_LONG; parg: Pointer): TIdC_LONG cdecl; external 'libcrypto-1_1.dll';
  function BIO_callback_ctrl(b: PBIO; cmd: TIdC_INT; fp: PBIO_info_cb): TIdC_LONG cdecl; external 'libcrypto-1_1.dll';
  function BIO_ptr_ctrl(bp: PBIO; cmd: TIdC_INT; larg: TIdC_LONG): Pointer cdecl; external 'libcrypto-1_1.dll';
  function BIO_int_ctrl(bp: PBIO; cmd: TIdC_INT; larg: TIdC_LONG; iarg: TIdC_INT): TIdC_LONG cdecl; external 'libcrypto-1_1.dll';
  function BIO_push(b: PBIO; append: PBIO): PBIO cdecl; external 'libcrypto-1_1.dll';
  function BIO_pop(b: PBIO): PBIO cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_free_all(a: PBIO) cdecl; external 'libcrypto-1_1.dll';
  function BIO_find_type(b: PBIO; bio_type: TIdC_INT): PBIO cdecl; external 'libcrypto-1_1.dll';
  function BIO_next(b: PBIO): PBIO cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_set_next(b: PBIO; next: PBIO) cdecl; external 'libcrypto-1_1.dll';
  function BIO_get_retry_BIO(bio: PBIO; reason: TIdC_INT): PBIO cdecl; external 'libcrypto-1_1.dll';
  function BIO_get_retry_reason(bio: PBIO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_set_retry_reason(bio: PBIO; reason: TIdC_INT) cdecl; external 'libcrypto-1_1.dll';
  function BIO_dup_chain(&in: PBIO): PBIO cdecl; external 'libcrypto-1_1.dll';

  function BIO_nread0(bio: PBIO; buf: PPIdAnsiChar): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_nread(bio: PBIO; buf: PPIdAnsiChar; num: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_nwrite0(bio: PBIO; buf: PPIdAnsiChar): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_nwrite(bio: PBIO; buf: PPIdAnsiChar; num: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';

  function BIO_debug_callback(bio: PBIO; cmd: TIdC_INT; const argp: PIdAnsiChar; argi: TIdC_INT; argl: TIdC_LONG; ret: TIdC_LONG): TIdC_LONG cdecl; external 'libcrypto-1_1.dll';

  function BIO_s_mem: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_s_secmem: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_new_mem_buf(const buf: Pointer; len: TIdC_INT): PBIO cdecl; external 'libcrypto-1_1.dll';

  function BIO_s_socket: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_s_connect: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_s_accept: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';

  function BIO_s_fd: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_s_log: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_s_bio: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_s_null: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_f_null: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_f_buffer: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_f_linebuffer: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_f_nbio_test: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_s_datagram: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_dgram_non_fatal_error(error: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_new_dgram(fd: TIdC_INT; close_flag: TIdC_INT): PBIO cdecl; external 'libcrypto-1_1.dll';

  function BIO_s_datagram_sctp: BIO_METHOD cdecl; external 'libcrypto-1_1.dll';
  function BIO_new_dgram_sctp(fd: TIdC_INT; close_flag: TIdC_INT): PBIO cdecl; external 'libcrypto-1_1.dll';
  function BIO_dgram_is_sctp(bio: PBIO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
//  function BIO_dgram_sctp_notification_cb(bio: PBIO; handle_notifications(PBIO;
//    context: Pointer;
//    buf: Pointer): TIdC_INT, Pointer context);
  function BIO_dgram_sctp_wait_for_dry(b: PBIO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_dgram_sctp_msg_waiting(b: PBIO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';

  function BIO_sock_should_retry(i: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_sock_non_fatal_error(error: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';

  function BIO_fd_should_retry(i: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_fd_non_fatal_error(error: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
...
//  function BIO_dump_indent_cb(TIdC_INT (cb( Pointer data, TIdC_SIZET len, Pointer function ): u: TIdC_INT, Pointer function ,  PIdAnsiChar s, TIdC_INT len, TIdC_INT indent): u;
  function BIO_dump(b: PBIO; const bytes: PIdAnsiChar; len: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_dump_indent(b: PBIO; const bytes: PIdAnsiChar; len: TIdC_INT; indent: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
...
//  function BIO_dump_indent_fp(fp: cFile; const s: PByte; len: TIdC_INT; indent: TIdC_INT): TIdC_INT;
  ...
  function BIO_hex_string(&out: PBIO; indent: TIdC_INT; width: TIdC_INT; data: PByte; datalen: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';

  function BIO_ADDR_new: PBIO_ADDR cdecl; external 'libcrypto-1_1.dll';
  function BIO_ADDR_rawmake(ap: PBIO_ADDR; familiy: TIdC_INT; const where: Pointer; wherelen: TIdC_SIZET; port: TIdC_SHORT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_ADDR_free(a: PBIO_ADDR) cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_ADDR_clear(ap: PBIO_ADDR) cdecl; external 'libcrypto-1_1.dll';
  function BIO_ADDR_family(const ap: PBIO_ADDR): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_ADDR_rawaddress(const ap: PBIO_ADDR; p: Pointer; l: PIdC_SIZET): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_ADDR_rawport(const ap: PBIO_ADDR): TIdC_SHORT cdecl; external 'libcrypto-1_1.dll';
  function BIO_ADDR_hostname_string(const ap: PBIO_ADDR; numeric: TIdC_INT): PIdAnsiChar cdecl; external 'libcrypto-1_1.dll';
  function BIO_ADDR_service_string(const ap: PBIO_ADDR; numeric: TIdC_INT): PIdAnsiChar cdecl; external 'libcrypto-1_1.dll';
  function BIO_ADDR_path_string(const ap: PBIO_ADDR): PIdAnsiChar cdecl; external 'libcrypto-1_1.dll';

  function BIO_ADDRINFO_next(const bai: PBIO_ADDRINFO): PBIO_ADDRINFO cdecl; external 'libcrypto-1_1.dll';
  function BIO_ADDRINFO_family(const bai: PBIO_ADDRINFO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_ADDRINFO_socktype(const bai: PBIO_ADDRINFO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_ADDRINFO_protocol(const bai: PBIO_ADDRINFO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_ADDRINFO_address(const bai: PBIO_ADDRINFO): PBIO_ADDR cdecl; external 'libcrypto-1_1.dll';
  procedure BIO_ADDRINFO_free(bai: PBIO_ADDRINFO) cdecl; external 'libcrypto-1_1.dll';

  function BIO_parse_hostserv(const hostserv: PIdAnsiChar; host: PPIdAnsiChar; service: PPIdAnsiChar; hostserv_prio: BIO_hostserv_priorities): TIdC_INT cdecl; external 'libcrypto-1_1.dll';

  function BIO_lookup(const host: PIdAnsiChar; const service: PIdAnsiChar; lookup_type: BIO_lookup_type; family: TIdC_INT; socktype: TIdC_INT; res: PPBIO_ADDRINFO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_lookup_ex(const host: PIdAnsiChar; const service: PIdAnsiChar; lookup_type: TIdC_INT; family: TIdC_INT; socktype: TIdC_INT; protocol: TIdC_INT; res: PPBIO_ADDRINFO): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_sock_error(sock: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_socket_ioctl(fd: TIdC_INT; cType: TIdC_LONG; arg: Pointer): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_socket_nbio(fd: TIdC_INT; mode: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_sock_init: TIdC_INT cdecl; external 'libcrypto-1_1.dll';

  function BIO_set_tcp_ndelay(sock: TIdC_INT; turn_on: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';

  function BIO_sock_info(sock: TIdC_INT; &type: BIO_sock_info_type; info: PBIO_sock_info_u): TIdC_INT cdecl; external 'libcrypto-1_1.dll';

  function BIO_socket(domain: TIdC_INT; socktype: TIdC_INT; protocol: TIdC_INT; options: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_connect(sock: TIdC_INT; const addr: PBIO_ADDR; options: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_bind(sock: TIdC_INT; const addr: PBIO_ADDR; options: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_listen(sock: TIdC_INT; const addr: PBIO_ADDR; options: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_accept_ex(accept_sock: TIdC_INT; addr: PBIO_ADDR; options: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  function BIO_closesocket(sock: TIdC_INT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';

  function BIO_new_socket(sock: TIdC_INT; close_flag: TIdC_INT): PBIO cdecl; external 'libcrypto-1_1.dll';
  function BIO_new_connect(const host_port: PIdAnsiChar): PBIO cdecl; external 'libcrypto-1_1.dll';
  function BIO_new_accept(const host_port: PIdAnsiChar): PBIO cdecl; external 'libcrypto-1_1.dll';

  function BIO_new_fd(fd: TIdC_INT; close_flag: TIdC_INT): PBIO cdecl; external 'libcrypto-1_1.dll';

  function BIO_new_bio_pair(bio1: PPBIO; writebuf1: TIdC_SIZET; bio2: PPBIO; writebuf2: TIdC_SIZET): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  (*
  ...
  procedure BIO_copy_next_retry(b: PBIO) cdecl; external 'libcrypto-1_1.dll';

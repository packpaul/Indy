...
// Generation date: 28.03.2020 11:31:43
...
//  {$HPPEMIT '# define BIO_wpending(b)         (int)BIO_ctrl(b,BIO_CTRL_WPENDING,0,NULL)'}
  ...
  function BIO_ctrl_pending(b: PBIO): size_t cdecl; external 'libcrypto-1_1.dll';
  function BIO_ctrl_wpending(b: PBIO): size_t cdecl; external 'libcrypto-1_1.dll';
...
//  {$HPPEMIT '# define BIO_get_read_request(b)    (int)BIO_ctrl(b,BIO_C_GET_READ_REQUEST,0,NULL)'}
  function BIO_ctrl_get_write_guarantee(b: PBIO): size_t cdecl; external 'libcrypto-1_1.dll';
  function BIO_ctrl_get_read_request(b: PBIO): size_t cdecl; external 'libcrypto-1_1.dll';
...
//  function BIO_new_fp(stream: cFile; close_flag: TIdC_INT): PBIO;
  ...
  function BIO_read_ex(b: PBIO; data: Pointer; dlen: size_t; readbytes: Psize_t): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  ...
  function BIO_write_ex(b: PBIO; const data: Pointer; dlen: size_t; written: Psize_t): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
...
//  function BIO_dump_indent_fp(fp: cFile; const s: PByte; len: TIdC_INT; indent: TIdC_INT): TIdC_INT;
  ...
  function BIO_ADDR_rawmake(ap: PBIO_ADDR; familiy: TIdC_INT; const where: Pointer; wherelen: size_t; port: TIdC_SHORT): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  ...
  function BIO_ADDR_rawaddress(const ap: PBIO_ADDR; p: Pointer; l: Psize_t): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  ...
  function BIO_new_bio_pair(bio1: PPBIO; writebuf1: size_t; bio2: PPBIO; writebuf2: size_t): TIdC_INT cdecl; external 'libcrypto-1_1.dll';
  (*

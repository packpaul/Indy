...
var
   ...
   *)
  function SSL_get_finished(const s: PSSL; buf: Pointer; count: Size_t): Size_t;
  function SSL_get_peer_finished(const s: PSSL; buf: Pointer; count: Size_t): Size_t;
  ...
  function SSL_CTX_use_serverinfo(ctx: PSSL_CTX; const serverinfo: PByte; serverinfo_length: size_t): TIdC_INT;
  function SSL_CTX_use_serverinfo_ex(ctx: PSSL_CTX; version: TIdC_UINT; const serverinfo: PByte; serverinfo_length: size_t): TIdC_INT;
  ...
  procedure SSL_SESSION_get0_alpn_selected(const s: PSSL_SESSION; const alpn: PPByte; len: PSize_t);
  function SSL_SESSION_set1_alpn_selected(s: PSSL_SESSION; const alpn: PByte; len: size_t): TIdC_INT;
  ...
  procedure SSL_SESSION_get0_ticket(const s: PSSL_SESSION; const tick: PPByte; len: PSize_t);
  ...
  function SSL_dane_tlsa_add(s: PSSL; usage: TIdC_UINT8; selector: TIdC_UINT8; mtype: TIdC_UINT8; const data: PByte; dlen: size_t): TIdC_INT;
  function SSL_get0_dane_authority(s: PSSL; mcert: PPX509; mspki: PPEVP_PKEY): TIdC_INT;
  function SSL_get0_dane_tlsa(s: PSSL; usage: PIdC_UINT8; selector: PIdC_UINT8; mtype: PIdC_UINT8; const data: PPByte; dlen: Psize_t): TIdC_INT;
  (*
  ...
  function SSL_client_hello_get0_random(s: PSSL; const &out: PPByte): Size_t;
  function SSL_client_hello_get0_session_id(s: PSSL; const &out: PPByte): Size_t;
  function SSL_client_hello_get0_ciphers(s: PSSL; const &out: PPByte): Size_t;
  function SSL_client_hello_get0_compression_methods(s: PSSL; const &out: PPByte): Size_t;
  function SSL_client_hello_get1_extensions_present(s: PSSL; &out: PPIdC_INT; outlen: PSize_t): TIdC_INT;
  function SSL_client_hello_get0_ext(s: PSSL; &type: TIdC_UINT; const &out: PPByte; outlen: PSize_t): TIdC_INT;
  ...
  function SSL_get_all_async_fds(s: PSSL; fds: POSSL_ASYNC_FD; numfds: Psize_t): TIdC_INT;
  function SSL_get_changed_async_fds(s: PSSL; addfd: POSSL_ASYNC_FD; numaddfds: Psize_t; delfd: POSSL_ASYNC_FD; numdelfds: Psize_t): TIdC_INT;
  ...
  function SSL_read_ex(ssl: PSSL; buf: Pointer; num: size_t; readbytes: Psize_t): TIdC_INT;

  function SSL_read_early_data(s: PSSL; buf: Pointer; num: size_t; readbytes: Psize_t): TIdC_INT;
  function SSL_peek(ssl: PSSL; buf: Pointer; num: TIdC_INT): TIdC_INT;
  function SSL_peek_ex(ssl: PSSL; buf: Pointer; num: size_t; readbytes: Psize_t): TIdC_INT;
  function SSL_write(ssl: PSSL; const buf: Pointer; num: TIdC_INT): TIdC_INT;
  function SSL_write_ex(s: PSSL; const buf: Pointer; num: size_t; written: Psize_t): TIdC_INT;
  function SSL_write_early_data(s: PSSL; const buf: Pointer; num: size_t; written: Psize_t): TIdC_INT;
  ...
  function SSL_get_client_random(const ssl: PSSL; &out: PByte; outlen: size_t): size_t;
  function SSL_get_server_random(const ssl: PSSL; &out: PByte; outlen: size_t): size_t;
  function SSL_SESSION_get_master_key(const sess: PSSL_SESSION; &out: PByte; outlen: size_t): size_t;
  function SSL_SESSION_set1_master_key(sess: PSSL_SESSION; const &in: PByte; len: size_t): TIdC_INT;
  ...
  procedure SSL_CTX_set_default_read_buffer_len(ctx: PSSL_CTX; len: Size_t);
  procedure SSL_set_default_read_buffer_len(s: PSSL; len: Size_t);
  ...
  function SSL_CTX_set_block_padding(ctx: PSSL_CTX; block_size: Size_t): TIdC_INT;
  ...
  function SSL_set_block_padding(ssl: PSSL; block_size: Size_t): TIdC_INT;
  function SSL_set_num_tickets(s: PSSL; num_tickets: Size_t): TIdC_INT;
  function SSL_get_num_tickets(const s: PSSL): Size_t;
  function SSL_CTX_set_num_tickets(ctx: PSSL_CTX; num_tickets: Size_t): TIdC_INT;
  function SSL_CTX_get_num_tickets(const ctx: PSSL_CTX): Size_t;
  ...
  procedure SSL_trace(write_p: TIdC_INT; version: TIdC_INT; content_type: TIdC_INT; const buf: Pointer; len: Size_t; ssl: PSSL; arg: Pointer);
  ...
  function SSL_SESSION_set1_ticket_appdata(ss: PSSL_SESSION; const data: Pointer; len: Size_t): TIdC_INT;
  function SSL_SESSION_get0_ticket_appdata(ss: PSSL_SESSION; data: PPointer; len: PSize_t): TIdC_INT;
